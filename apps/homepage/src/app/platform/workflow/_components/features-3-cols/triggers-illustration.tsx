...
import { Clock, Mail, User, Webhook } from 'lucide-react'

// TriggersIllustration renders the messaging avatar bubble used in the feature card.
export const TriggersIllustration = () => {
  return (
