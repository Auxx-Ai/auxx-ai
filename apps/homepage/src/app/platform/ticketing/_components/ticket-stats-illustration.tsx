export const TicketStatsIllustration = () => {
  return (
    <div
      aria-hidden
      className='mask-b-from-65% dark:mask-b-from-80% before:bg-background before:border-border after:border-border after:bg-background/50 before:z-1 group relative -mx-4 px-4 pt-6 before:absolute before:inset-x-6 before:bottom-0 before:top-4 before:rounded-2xl before:border after:absolute after:inset-x-9 after:bottom-0 after:top-2 after:rounded-2xl after:border'>
      <div className='bg-illustration dark:bg-[#0c0c10] ring-border-illustration relative z-10 rounded-2xl p-6 shadow-xl shadow-black/10 ring-1'>
        <div className='text-foreground font-medium'>
          <span className='bg-green-100 dark:bg-green-900/40 px-2 py-1 rounded text-green-900 dark:text-green-200'>
            Ticket
          </span>{' '}
          Performance
        </div>
        ...
        <div className='relative mb-4 mt-4 flex'>
          <div className='h-5 w-4/5 rounded-l-md bg-green-500 dark:bg-green-900' />
          <div className='h-5 w-1/5 rounded-r-md border duration-300 [--stripes-color:theme(colors.zinc.300)] dark:[--stripes-color:theme(colors.zinc.700)] [background-image:linear-gradient(-45deg,var(--stripes-color)_25%,transparent_25%,transparent_50%,var(--stripes-color)_50%,var(--stripes-color)_75%,transparent_75%,transparent)] [background-size:5px_5px]' />
        </div>
