            ...
            <div className='mx-auto w-full max-w-5xl px-6'>
              <div className='grid max-md:divide-y md:grid-cols-2 md:divide-x'>
                <div className='row-span-2 grid grid-rows-subgrid gap-8 pb-12 md:pr-12'>
                  <div>
                    <h3 className='text-foreground text-xl font-semibold'>Fast and Intuitive</h3>
                    <p className='text-muted-foreground mt-4 text-lg'>
                      An easy-to-use interface helps your agents handle complex support tickets
                      fast, together as a team.
                    </p>
                  </div>
                ...
                <div className='row-span-2 grid grid-rows-subgrid gap-8 pb-12 max-md:pt-12 md:pl-12'>
                  <div>
                    ...
                    <p className='text-muted-foreground mt-4 text-lg'>
                      See how to improve with out-of-the-box ticketing metrics on team performance
              ...
              <div className='relative grid grid-cols-2 gap-x-3 gap-y-6 border-t pt-12 sm:gap-6 lg:grid-cols-4'>
                <div className='space-y-3'>
                  ...
                  <p className='text-muted-foreground text-sm'>
                    An easy-to-use interface helps your agents handle complex support tickets fast,
                    together as a team.
                  </p>
                </div>
                <div className='space-y-2'>
                  ...
                  <p className='text-muted-foreground text-sm'>
                    Skip the rigid, legacy ticketing systems. Front organizes your workflow and
                ...
                <div className='space-y-2'>
                  ...
                  <p className='text-muted-foreground text-sm'>
                    See how to improve with out-of-the-box ticketing metrics on team performance and
                ...
                <div className='space-y-2'>
                  ...
                  <p className='text-muted-foreground text-sm'>
                    Enable seamless collaboration between agents with shared ticket views, internal
                    notes, and assignment workflows.
                  </p>
                </div>
              </div>
            </div>
