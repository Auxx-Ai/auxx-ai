    ...
    <div
      ...
      <div className='bg-illustration ring-border-illustration relative z-10 rounded-2xl p-6 shadow-xl shadow-black/10 ring-1'>
        <div className='text-foreground font-medium'>
          <span className='bg-blue-100 dark:bg-blue-900/40 px-2 py-1 rounded text-blue-900 dark:text-blue-200'>
            Precision Parts Inc.
          </span>
        </div>
        ...
        <div className='relative mb-4 mt-4 flex'>
          <div className='h-5 w-4/5 rounded-l-md bg-blue-500 dark:bg-blue-900' />
