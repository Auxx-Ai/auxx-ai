    ...
    <section className='relative overflow-hidden border-foreground/10 border-b'>
      ...
      <div className='relative z-10 mx-auto max-w-6xl border-x px-3'>
        <div className='border-x'>
          <div className='bg-background/40 py-24'>
                  ...
                  {metrics.map((metric, index) => {
                    ...
                    return (
                      <motion.div
                        ...
                        viewport={{ once: true }}
                        className='bg-zinc-50/80 dark:bg-zinc-900/50 relative backdrop-blur-sm rounded-3xl ring-foreground/10 ring-1 shadow-black/5  p-6 shadow-md text-center'>
