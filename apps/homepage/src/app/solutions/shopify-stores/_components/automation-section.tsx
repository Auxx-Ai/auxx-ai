// apps/web/src/app/(website)/solutions/shopify-stores/_components/automation-section.tsx
'use client'
import { motion } from 'motion/react'
import { Badge } from '~/components/ui/badge'
import { MessageSquare, RefreshCw, Search, Clock, TrendingUp } from 'lucide-react'
...
const automationWorkflows = [
  {
    ...
    automation: 'AI fetches tracking info and provides real-time updates',
    timesSaved: '4 mins',
    accuracy: '99.8%',
    steps: [
  ...
  },
  {
    ...
    automation: 'AI validates return policy and initiates refund process',
    timesSaved: '8 mins',
    accuracy: '97.2%',
    steps: [
  ...
  },
  {
    ...
    description: 'Customer needs product information',
    automation: 'AI provides detailed specs and recommendations',
    timesSaved: '5 mins',
    accuracy: '95.4%',
    steps: [
      'Identify product inquiry',
            ...
            <div className="relative z-10 mx-auto ">
              <motion.div
                ...
                <h2 className="text-4xl font-semibold mb-6 text-foreground">
                  Automate Complex E-commerce Support
                </h2>
                <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                  Our AI handles the most common support scenarios automatically, from order
                  inquiries to returns, freeing your team to focus on complex issues that need human
                  touch.
                </p>
              </motion.div>
