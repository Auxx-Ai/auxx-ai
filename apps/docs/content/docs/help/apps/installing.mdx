...
After installation, you may need to set up a connection (API key or OAuth) before the app is fully functional. See [Managing installed apps](/help/apps/managing) for details.
