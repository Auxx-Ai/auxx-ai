...
- You must have a **password set** on your account before enabling 2FA. If you signed up with Google or GitHub only, add a password first in [Account settings](/help/account/settings).
