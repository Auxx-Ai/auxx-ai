...
| **Relationship** | Link to records in another entity (see [Relationship fields](/help/custom-entities/relationships)) |
...
<Cards>
  <Card title="Relationship fields" href="/help/custom-entities/relationships">
