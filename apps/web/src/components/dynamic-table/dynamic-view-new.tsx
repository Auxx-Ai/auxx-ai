// apps/web/src/components/dynamic-table/dynamic-view-new.tsx
'use client'

import { useMemo, useRef, Children, isValidElement, useState, useCallback } from 'react'
import { useDynamicTable } from './hooks/use-dynamic-table-new'
import { useCellNavigation } from './hooks/use-cell-navigation'
import { TableToolbarNew } from './components/table-toolbar/table-toolbar-new'
import { TableBodyNew } from './components/table-body-new'
import { KanbanViewBodyNew } from './components/kanban-view-body-new'
...
import { CellSelectionConfigProvider, useCellSelection } from './context/cell-selection-context-new'
  ...
  return (
    <div ref={scrollContainerRef} className="flex flex-col relative h-full flex-1 overflow-auto">
      ...
      {isInitialLoading ? (
        ...
        <>
          <TableBodyNew hideToolbar={hideToolbar} scrollContainerRef={scrollContainerRef} />
          <div className="grow" />
        </>
      )}
