// apps/web/src/components/dynamic-table/components/table-body-new.tsx
'use client'
...
import { VirtualTableBody } from './virtual-table-body-new'
import { HeaderCellWrapper } from './header-cell-wrapper'
import { CheckboxHeaderCell } from './checkbox-header-cell-new'
import { ColumnDndProvider } from './column-dnd-provider'
import { RowDndProvider } from './row-dnd-provider-new'
 ...
 */
export function TableBodyNew<TData extends object>({
  hideToolbar,
  scrollContainerRef,
}: TableBodyProps) {
