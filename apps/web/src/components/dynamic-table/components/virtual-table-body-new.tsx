// apps/web/src/components/dynamic-table/components/virtual-table-body-new.tsx
...
import { DragDropRow } from './drag-drop-row-new'
import { useTableConfig } from '../context/table-config-context'
import { useRowSelection } from '../context/row-selection-context-new'
