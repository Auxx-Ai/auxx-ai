// apps/web/src/components/dynamic-table/components/table-toolbar/table-toolbar-new.tsx
...
import { ColumnManagerNew } from './column-manager-new'
import { KanbanViewSettings } from './kanban-view-settings-new'
 ...
 */
export function TableToolbarNew<TData = any>({
  children,
  className,
  searchQuery,
  setSearchQuery,
  ...
  return (
    <div
      ...
      {isKanbanView ? <KanbanViewSettings /> : <ColumnManagerNew />}
...
TableToolbarNew.displayName = 'TableToolbarNew'
