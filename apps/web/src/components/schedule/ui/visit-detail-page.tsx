...
//
// The Visit tab + Notes tab (08-worker-surface.md §3) — a bespoke mobile-first page reading
// `api.dispatch.getMyVisit`. Money-hidden by construction: the server payload never includes
// price fields, this page never re-adds them.
