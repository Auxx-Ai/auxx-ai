  ...
  return (
    <div className="space-y-2">
      ...
      <p className="text-[0.8rem] text-muted-foreground">
        ...
        {!isPending && registrationMethod === 'mixed' &&
          'You can sign in using any of your connected authentication methods.'}
        {!isPending && registrationMethod === 'oauth' &&
          uniqueProviders.length > 0 &&
          'You can sign in using your connected OAuth provider(s).'}
        {!isPending && registrationMethod === 'email' && 'You can sign in using your email and password.'}
        {!isPending && registrationMethod === 'phone' && 'You can sign in using your phone number and SMS verification.'}
        {!isPending && (!registrationMethod || uniqueProviders.length === 0 || uniqueProviders.includes('loading')) &&
