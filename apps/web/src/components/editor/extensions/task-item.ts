...
export const TaskItem = Node.create<TaskItemOptions>({
  ...
  content() {
    // paragraph block*:  must have exact one paragraph at the top, and must have zero or more blocks
    // paragraph+: must have  one or more paragraph

    return this.options.nested ? 'paragraph block*' : 'paragraph+'
  },

  // Besides the already visible text selection, there is an invisible node selection.
  // If you want to make your nodes selectable, you can configure it like this:
  //  selectable: true,

  //  All nodes can be configured to be draggable (by default they aren’t) with this settings
  //  draggable: true,

  // Nodes get dropped when their entire content is replaced (for example, when pasting new content) by default.
  //  If a node should be kept for such replace operations, configure them as defining.
  defining: true,
