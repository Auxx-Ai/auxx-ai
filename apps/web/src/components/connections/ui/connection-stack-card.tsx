 ...
 * shared {@link AppListCard} so it matches every other tile, with 1–2 dimmer cards offset behind
...
export function ConnectionStackCard({ group, onToggle }: ConnectionStackCardProps) {
  ...
  return (
    <div className='relative'>
      ...
      {/* The real face sits above the deck (AppListCard is `w-full`, so it fills the column). */}
      <div className='relative'>
        <AppListCard
          title={group.label}
