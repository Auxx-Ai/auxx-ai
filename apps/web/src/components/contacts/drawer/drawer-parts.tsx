// apps/web/src/components/contacts/drawer/drawer-parts.tsx
'use client'

import { useState, useCallback } from 'react'
import Link from 'next/link'
import { Package, MoreHorizontal, Edit, Trash2, PlusCircle, Star } from 'lucide-react'
...
/** Props for DrawerParts component */
interface DrawerPartsProps {
  /** The contact ID to show parts for */
  contactId: string
}

/** Parts tab content for contact drawer - shows parts this contact supplies */
export default function DrawerParts({ contactId }: DrawerPartsProps) {
