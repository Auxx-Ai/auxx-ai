// apps/web/src/components/apps/host/message-client-wrapper.tsx
'use client'

import { useEffect, useMemo, useRef } from 'react'
import { useInternalAppsContext } from '~/components/apps/providers/internal-apps-context'
import { MessageClient } from '~/components/apps/runtime/message-client'
import { setupServerFunctionHandler } from '~/components/apps/runtime/server-function-handler'
import {
