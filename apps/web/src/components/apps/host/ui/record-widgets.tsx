// apps/web/src/components/apps/host/ui/record-widgets.tsx
'use client'

import { AppWidget } from '~/components/apps/host/app-widget'
 ...
 * - Renders each widget using AppWidget component
