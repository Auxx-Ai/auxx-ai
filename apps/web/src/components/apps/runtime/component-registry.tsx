// apps/web/src/components/apps/runtime/component-registry.tsx
...
import { Form as FormComponent } from '~/components/apps/rendering/forms/form-reconstructor'
// Workflow components
import {
  WorkflowNode,
  WorkflowNodeHandle,
  ...
  WorkflowNodeText,
  WorkflowPanel,
} from '~/components/workflow/apps/primitives'
import { WorkflowFieldDivider } from '~/components/workflow/apps/primitives/fields/field-divider'
import { WorkflowFieldRow } from '~/components/workflow/apps/primitives/fields/field-row'
import { WorkflowVarField } from '~/components/workflow/apps/primitives/fields/var-field'
import { WorkflowVarFieldGroup } from '~/components/workflow/apps/primitives/fields/var-field-group'
import { ArrayInputInternal } from '~/components/workflow/apps/primitives/inputs/array-input-internal'
import { VarInputInternal } from '~/components/workflow/apps/primitives/inputs/var-input'
import {
  InputGroup,
  Section,
  Separator as WorkflowSeparatorComponent,
} from '~/components/workflow/apps/primitives/layout'
import { WorkflowAlert } from '~/components/workflow/apps/primitives/utility/alert'
import { WorkflowBadge } from '~/components/workflow/apps/primitives/utility/badge'
import { ConditionalRender } from '~/components/workflow/apps/primitives/utility/conditional-render'
import { InputEditor } from '~/components/workflow/apps/primitives/variables/input-editor'
import { VariableInput } from '~/components/workflow/apps/primitives/variables/variable-input'
