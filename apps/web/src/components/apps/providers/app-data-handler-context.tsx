// apps/web/src/components/apps/providers/app-data-handler-context.tsx
'use client'

import { createContext, type ReactNode, useContext } from 'react'
import { useMessageClient } from '~/components/apps/runtime/hooks/use-message-client'
import type { MessageClient } from '~/components/apps/runtime/message-client'
 ...
 */
interface AppDataHandlerContextValue {
 ...
 */
const AppDataHandlerContext = createContext<AppDataHandlerContextValue | null>(null)
 ...
 */
export function AppDataHandlerContextProvider({
  appId,
  appInstallationId,
  isDevLoggingEnabled,
  children,
  ...
  return (
    <AppDataHandlerContext.Provider
 ...
 * @throws {Error} If used outside of AppDataHandlerContextProvider
 */
export function useAppDataHandlerContext() {
  const context = useContext(AppDataHandlerContext)

  if (!context) {
    throw new Error('useAppDataHandlerContext must be used within AppDataHandlerContextProvider')
  }
