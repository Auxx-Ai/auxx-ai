...
const SHORTCUTS = [
  ...
  { keys: ['J'], label: 'Next workflow' },
  { keys: ['K'], label: 'Previous workflow' },
...
export const GettingStartedOverlay = memo(function GettingStartedOverlay({
  ...
  return (
    <div
      className='absolute inset-0 z-50 flex sm:items-center sm:justify-center sm:backdrop-blur-sm sm:bg-black/20 sm:dark:bg-black/40'
      onClick={(e) => {
        if (e.target === e.currentTarget && hasNodes) onClose()
      }}>
      <div
        className='bg-background sm:bg-background/90 sm:backdrop-blur-md sm:border sm:rounded-xl sm:shadow-lg sm:max-w-[720px] w-full sm:mx-4 flex-1 sm:flex-none flex flex-col'
        onClick={(e) => e.stopPropagation()}>
        <div className='overflow-y-auto sm:overflow-y-hidden flex-1 min-h-0 sm:flex-none sm:min-h-auto'>
          <div className='p-6'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
              ...
              <div className='space-y-3'>
                ...
                <div className='space-y-2 text-xs text-muted-foreground'>
                  ...
                  <p>
                    <span className='font-medium text-foreground'>Array variables:</span>{' '}
                    Right-click a variable tag to pick an item — first, last, all, or by index.
                  </p>
