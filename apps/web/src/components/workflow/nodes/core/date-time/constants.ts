...
export const DATE_FORMAT_OPTIONS: DateTimeSelectOption[] = [
  ...
  {
    value: DateFormatType.RELATIVE,
    label: 'Relative',
    description: 'last Monday at 2:30 PM',
  },
  { value: DateFormatType.LONG, label: 'Long Format', description: 'Monday, January 1st, 2024' },
  { value: DateFormatType.SHORT, label: 'Short Format', description: 'Jan 01, 2024' },
