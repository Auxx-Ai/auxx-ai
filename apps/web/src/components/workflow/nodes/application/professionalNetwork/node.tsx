...
export const ProfessionalNetworkNode = memo<ProfessionalNetworkNodeProps>(
  ({ id, data, selected }) => {
    return (
        ...
        <div className='space-y-2 pb-2'>
          ...
          {data.textContent && (
            <div className='relative px-2'>
              <div className='rounded-md bg-gray-50 p-2'>
                <p className='text-xs text-gray-600 line-clamp-2'>{data.textContent}</p>
              </div>
            </div>
          )}
          ...
          <div className='relative px-2'>
            <div className='flex items-center justify-between text-xs'>
              <span className='capitalize text-gray-500'>{data.action}</span>
            </div>
          </div>
        </div>
