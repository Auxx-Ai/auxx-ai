...
import { AppWorkflowPanel } from '~/components/workflow/apps/app-workflow-panel'
import { resolveAppBlockOutputFields } from '~/components/workflow/apps/resolve-app-outputs'
import { AppTriggerInput } from '~/components/workflow/apps/trigger/app-trigger-input'
import {
  registerDynamicTriggerInput,
  unregisterDynamicTriggerInput,
} from '~/components/workflow/nodes/trigger-registry'
import type { WorkflowBlock, WorkflowBlockOutput } from '~/components/workflow/types/block-types'
import type {
  NodeDefinition,
  NodePanelProps,
  ValidationResult,
