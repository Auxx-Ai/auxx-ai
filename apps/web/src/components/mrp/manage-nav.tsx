...
export const MANAGE_NAV: SidebarProps[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'manage-mrp-settings',
        label: 'Settings',
        slug: 'mrp-settings',
        icon: <Settings2 />,
        description: 'Usage window, default factors and run retention',
        keywords: ['mrp', 'adu window', 'lead-time factor', 'variability', 'retention'],
        permissionKey: PermissionKey.mrpManage,
        featureKey: FeatureKey.mrp,
      },
    ],
  },
