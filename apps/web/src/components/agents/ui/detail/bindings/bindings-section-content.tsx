...
interface BindingsSectionContentProps {
  ...
  /** Which tool's bindings are being edited (`null` ⇒ adding a new one). */
...
/**
 * Bindings section — the per-agent **override** layer, grouped by tool. Each
 * enabled tool with ≥1 override is a parent `TreeRow`; child rows are the
 * per-input overrides. Most agents have none (author defaults cover the common
