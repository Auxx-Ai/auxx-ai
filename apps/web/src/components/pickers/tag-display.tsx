// components/tags/tag-display.tsx
'use client'
...
export function SelectedTagsDisplay({
  ...
  const { getTagById, getTagDisplayName } = useTags()
...
function getContrastColor(hexColor: string): string {
  // Calculate luminance and return black/white depending on background brightness
