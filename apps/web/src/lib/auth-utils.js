        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, globalThis.crypto.subtle.importKey('raw', passwordBuffer, { name: 'PBKDF2' }, false, ['deriveBits'])
                        // Derive bits using PBKDF2
                    ];
                case 1:
                    importedKey = _a.sent();
                    return [4 /*yield*/, globalThis.crypto.subtle.deriveBits({ name: 'PBKDF2', salt: saltBuffer, iterations: 1000, hash: 'SHA-512' }, importedKey, 512 // 64 bytes (512 bits)
                        )
...
export function verifyPassword(password, storedSalt, storedHash) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, hashPassword(password, storedSalt)];
                case 1:
                    hash = (_a.sent()).hash;
...
export function parseStoredPassword(storedPassword) {
    var _a = storedPassword.split(':'), salt = _a[0], hash = _a[1];
