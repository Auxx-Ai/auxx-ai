...
import { AlertCircleIcon, ClipboardCopyIcon, InfoIcon, RefreshCwIcon } from 'lucide-react'
        ...
        <div className='space-y-6'>
          <Alert>
            ...
            <AlertDescription>
              <p className='mb-2'>
                Send an email to{' '}
                <span className='font-mono font-bold'>{`${domain.routingPrefix}new@${domain.domain}`}</span>{' '}
                to create a new ticket.
              </p>
              <p>
                Once a ticket is created, you can reply to the notification email to add more
                information.
              </p>
            </AlertDescription>
          </Alert>
