 ...
 *
 * The implementation moved to `@auxx/lib/accounting/providers/accounting-providers` on
 ...
 */
export { registerAccountingProviders } from '@auxx/lib/accounting/providers/accounting-providers'
