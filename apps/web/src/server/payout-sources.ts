 ...
 *
 * One registration in `@auxx/lib/accounting/money/payouts/sources`, two boot sequences
 ...
 */
export { registerPayoutSources } from '@auxx/lib/accounting/money/payouts/sources'
