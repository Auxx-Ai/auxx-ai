...
## [0.1.239](https://github.com/Auxx-Ai/auxx-ai/compare/auxx-v0.1.238...auxx-v0.1.239) (2026-09-26)


### Features

* **accounting:** a drawer for a Summary row — the journal it sends and its postings ([#2328](https://github.com/Auxx-Ai/auxx-ai/issues/2328)) ([16598da](https://github.com/Auxx-Ai/auxx-ai/commit/16598da49850e3473012b05b77b150d1941f53ed))
...
* **accounting:** active-once-set-up gate and money marks instead of record rules (110) ([#2364](https://github.com/Auxx-Ai/auxx-ai/issues/2364)) ([8a36897](https://github.com/Auxx-Ai/auxx-ai/commit/8a3689758f8625c0d7b28b1f4e7a34fd4ce0335c))
...
* **accounting:** add outbox category filters ([#2294](https://github.com/Auxx-Ai/auxx-ai/issues/2294)) ([1fb8863](https://github.com/Auxx-Ai/auxx-ai/commit/1fb88638d91758a49d428f4bc80736f476cb315a))
...
* **accounting:** authorize.net as a settlement source — the platform half ([#2266](https://github.com/Auxx-Ai/auxx-ai/issues/2266)) ([7f0380c](https://github.com/Auxx-Ai/auxx-ai/commit/7f0380cfe9f17ce0d973897b94e789e442d4d69b))
* **accounting:** batched QuickBooks send (93 D2–D5) ([#2307](https://github.com/Auxx-Ai/auxx-ai/issues/2307)) ([d1c70f5](https://github.com/Auxx-Ai/auxx-ai/commit/d1c70f5016cad119baf6ab0cda14f2fbd4e940ee))
* **accounting:** blocked names what to fix — gateway rows, add-gateway dialog, relief (100) ([#2319](https://github.com/Auxx-Ai/auxx-ai/issues/2319)) ([c3f32ab](https://github.com/Auxx-Ai/auxx-ai/commit/c3f32ab025ccc22817966dd3a1cdc883cd13d398))
* **accounting:** bulk Retry enqueues one release (93 C) ([#2306](https://github.com/Auxx-Ai/auxx-ai/issues/2306)) ([87b6c00](https://github.com/Auxx-Ai/auxx-ai/commit/87b6c00dfa220bd2ac3dab24c52af2d9eeb444fc))
...
* **accounting:** Connect and go — setup runs on connect, one result screen, finish (105 C9) ([#2341](https://github.com/Auxx-Ai/auxx-ai/issues/2341)) ([471d4ac](https://github.com/Auxx-Ai/auxx-ai/commit/471d4ac45218c248b60b34aef27a891d7bf64375))
* **accounting:** connect-and-go as wizard pages, mapping in setup, opening at zero ([#2344](https://github.com/Auxx-Ai/auxx-ai/issues/2344)) ([ce3e8e2](https://github.com/Auxx-Ai/auxx-ai/commit/ce3e8e2f29b3ec124984967d46aa5324941a4fe3))
* **accounting:** connect-and-go rails, book activation and bank-account proposals (105 C4, C5) ([#2335](https://github.com/Auxx-Ai/auxx-ai/issues/2335)) ([5ffc2c9](https://github.com/Auxx-Ai/auxx-ai/commit/5ffc2c94472a7d2669d3fe8962e50c592259d059))
...
* **accounting:** edit-in-place for quotes, purchase orders and orders (66 U5/U7) ([#2321](https://github.com/Auxx-Ai/auxx-ai/issues/2321)) ([f733466](https://github.com/Auxx-Ai/auxx-ai/commit/f733466f3b6ff239594d7b1d9fa5e16562a0cb14))
...
* **accounting:** failed batch remedies, refund gate, shipment poster (88 R1+R2, 89) ([#2301](https://github.com/Auxx-Ai/auxx-ai/issues/2301)) ([005846b](https://github.com/Auxx-Ai/auxx-ai/commit/005846b914e892a3d1316f40e49f28687933ca24))
* **accounting:** fewer calls per send, a live outbox (93 A+B) ([#2305](https://github.com/Auxx-Ai/auxx-ai/issues/2305)) ([5fde162](https://github.com/Auxx-Ai/auxx-ai/commit/5fde16234b36defd2b9e98633db8f42fdbbec8c0))
* **accounting:** fulfillment totals for synced shipments (78), guest contact and wake (79) ([#2286](https://github.com/Auxx-Ai/auxx-ai/issues/2286)) ([acef2e6](https://github.com/Auxx-Ai/auxx-ai/commit/acef2e63924892f1106f6acb9ed720465d4c08f9))
...
* **accounting:** lock in the closeout toolbar; one-panel provider settings; drop balance comparison ([#2347](https://github.com/Auxx-Ai/auxx-ai/issues/2347)) ([eed6de6](https://github.com/Auxx-Ai/auxx-ai/commit/eed6de60da401342026afa1e6de5d1879fd56303))
* **accounting:** match the provider's own transactions to ours (102 U0, U1b, U3–U5) ([#2325](https://github.com/Auxx-Ai/auxx-ai/issues/2325)) ([54c18a9](https://github.com/Auxx-Ai/auxx-ai/commit/54c18a9ff7b6fb99eba552ca66290b2fc1c45171))
* **accounting:** narrow-width journal table and compact outbox summary rows ([#2358](https://github.com/Auxx-Ai/auxx-ai/issues/2358)) ([1efc14f](https://github.com/Auxx-Ai/auxx-ai/commit/1efc14f238961d591ea3d6ec9391bd0ca444af8e))
...
* **accounting:** one category per posting, Outbox pages the Ready tab (92); 88 R2-R4 ([#2302](https://github.com/Auxx-Ai/auxx-ai/issues/2302)) ([29851a5](https://github.com/Auxx-Ai/auxx-ai/commit/29851a531808dab8306bd6a90e6a2c456cd50d8f))
* **accounting:** one entry per event — the order door stops replaying the order (91) ([#2313](https://github.com/Auxx-Ai/auxx-ai/issues/2313)) ([7ce3bbe](https://github.com/Auxx-Ai/auxx-ai/commit/7ce3bbe0dd9f8c12e5712e2268658d7519c9c6b8))
* **accounting:** one export table per avenue on the posting settings page ([#2308](https://github.com/Auxx-Ai/auxx-ai/issues/2308)) ([a6f1d0e](https://github.com/Auxx-Ai/auxx-ai/commit/a6f1d0eda913d69b0995af1b453387e71d9d63f5))
...
* **accounting:** one row design across the outbox, paged reads, the movement drawer ([#2269](https://github.com/Auxx-Ai/auxx-ai/issues/2269)) ([85bc332](https://github.com/Auxx-Ai/auxx-ai/commit/85bc3329dc70a3dd21589ccbac767d63f73070d1))
* **accounting:** one shell — one rail, one topbar, one scroll owner (81) ([#2288](https://github.com/Auxx-Ai/auxx-ai/issues/2288)) ([284978a](https://github.com/Auxx-Ai/auxx-ai/commit/284978ade258c41b4b42334cbc914d28bd7d7ef6))
...
* **accounting:** opening from the provider, server-side finalize, opening inventory adjustment (105 C6–C8) ([#2336](https://github.com/Auxx-Ai/auxx-ai/issues/2336)) ([a69067f](https://github.com/Auxx-Ai/auxx-ai/commit/a69067ff3b4a1b4d618582348a2dc610465864b8))
* **accounting:** optional readCompanySettings on the provider seam (105 C1) ([#2333](https://github.com/Auxx-Ai/auxx-ai/issues/2333)) ([d07fd22](https://github.com/Auxx-Ai/auxx-ai/commit/d07fd22deaa0ba3e1c83a3f6ae4bf55afaffb7cc))
...
* **accounting:** payouts drawer cleanup — one money format, real bank confirmation ([#2312](https://github.com/Auxx-Ai/auxx-ai/issues/2312)) ([4f5c4db](https://github.com/Auxx-Ai/auxx-ai/commit/4f5c4dbbfeb74a9976a213bba658abd8f7339e88))
...
* **accounting:** provider matches on screen, bill payments, payout gateway fix (102 U6–U8) ([#2326](https://github.com/Auxx-Ai/auxx-ai/issues/2326)) ([aa4edb4](https://github.com/Auxx-Ai/auxx-ai/commit/aa4edb4fe48cf6531ce5228a1795e99552c5427a))
* **accounting:** provider-neutral role hints in chart import, no duplicate core accounts, targeted import (105 C2, C3) ([#2334](https://github.com/Auxx-Ai/auxx-ai/issues/2334)) ([b6103bf](https://github.com/Auxx-Ai/auxx-ai/commit/b6103bfa416e88c841f089d1007d1d1156079a07))
* **accounting:** put approved drafts on the outbox Ready tab ([#2300](https://github.com/Auxx-Ai/auxx-ai/issues/2300)) ([9a89c2b](https://github.com/Auxx-Ai/auxx-ai/commit/9a89c2be6b189690c2ab84bc992f7cb046b55074))
...
* **accounting:** reports that scale — one virtualized grid, a paged ledger, drill in place (108) ([#2361](https://github.com/Auxx-Ai/auxx-ai/issues/2361)) ([9f24fc3](https://github.com/Auxx-Ai/auxx-ai/commit/9f24fc3c46438a9063b00f415a12a2685ff0fd2b))
...
* **accounting:** set costs from Blocked, typed and channel standards, $0 standards (106) ([#2357](https://github.com/Auxx-Ai/auxx-ai/issues/2357)) ([0c5d8e2](https://github.com/Auxx-Ai/auxx-ai/commit/0c5d8e23c0ee8f037a5e92b3798592191774a4f7))
...
* **accounting:** setup wizard welcome + books choice; no provider writes before Finish ([#2342](https://github.com/Auxx-Ai/auxx-ai/issues/2342)) ([2b0a593](https://github.com/Auxx-Ai/auxx-ai/commit/2b0a5937846592968e47638d22e2e6352c889a17))
...
* **accounting:** the chart and the provider chart in the org cache (84) ([#2304](https://github.com/Auxx-Ai/auxx-ai/issues/2304)) ([1688f60](https://github.com/Auxx-Ai/auxx-ai/commit/1688f602e677825dbc97419b603cd256774e8223))
...
* **accounting:** the document number is the document number (80) ([#2290](https://github.com/Auxx-Ai/auxx-ai/issues/2290)) ([90f4334](https://github.com/Auxx-Ai/auxx-ai/commit/90f4334efc6ece71148c1d4d76d020c37d200dd6))
...
* **accounting:** the export under one entry per event (101 E1, E5–E10) ([#2324](https://github.com/Auxx-Ai/auxx-ai/issues/2324)) ([706c481](https://github.com/Auxx-Ai/auxx-ai/commit/706c481dbb19b4c178a9da569ed78d69e0dff5a4))
...
* **accounting:** the ledger remembers its own draft — a `pending` link on every source (77) ([#2274](https://github.com/Auxx-Ai/auxx-ai/issues/2274)) ([a4b0ca1](https://github.com/Auxx-Ai/auxx-ai/commit/a4b0ca16ec97f1d434fcbaa18c19ef26b1c838e4))
* **accounting:** the month lock becomes Reviewed through — entries post on their real date (104 P1) ([#2366](https://github.com/Auxx-Ai/auxx-ai/issues/2366)) ([1a1e91d](https://github.com/Auxx-Ai/auxx-ai/commit/1a1e91d6d5364372ea6916401f0ab13cf2d5e72b))
* **accounting:** the movement is a badge, and the drawer drills (83) ([#2291](https://github.com/Auxx-Ai/auxx-ai/issues/2291)) ([fbd597b](https://github.com/Auxx-Ai/auxx-ai/commit/fbd597b29742c8d24a4510b4c917c524ed4697dc))
...
* **accounting:** the summary is the row — one unit per outbox view, Build folds into Send (95) ([#2310](https://github.com/Auxx-Ai/auxx-ai/issues/2310)) ([b2032b5](https://github.com/Auxx-Ai/auxx-ai/commit/b2032b556707c7afec5d6ad7af295989df196c01))
...
* **accounting:** what the 74 retest found (75) — the blocked lane, the two provisionings, Cancel's totals ([#2268](https://github.com/Auxx-Ai/auxx-ai/issues/2268)) ([e728d7a](https://github.com/Auxx-Ai/auxx-ai/commit/e728d7a83b318dca1d169c791ac09eb9fce4fd29))
...
* **ai:** decision modality — DECISION model type, evaluate() runner, hidden TypeSafe provider ([#2338](https://github.com/Auxx-Ai/auxx-ai/issues/2338)) ([b494d93](https://github.com/Auxx-Ai/auxx-ai/commit/b494d93a9aff24e92661a2e7d3b4ae7d24311055))
* **ai:** mail classification always runs on platform SYSTEM models ([#2349](https://github.com/Auxx-Ai/auxx-ai/issues/2349)) ([a43ea4b](https://github.com/Auxx-Ai/auxx-ai/commit/a43ea4beb13df4df03e483c93cd69c3adb5437d6))
* **ai:** mail classification on the decision runner, with four triage columns ([#2348](https://github.com/Auxx-Ai/auxx-ai/issues/2348)) ([44166cb](https://github.com/Auxx-Ai/auxx-ai/commit/44166cb3b7c7668f02e747bea0c8f9dd5fc3eb75))
...
* **builds:** backflush runs as a sliced job with live progress ([#2395](https://github.com/Auxx-Ai/auxx-ai/issues/2395)) ([1c783a8](https://github.com/Auxx-Ai/auxx-ai/commit/1c783a818dca825b656c2dfd3a3f60624e84dd9c))
* **channels:** dock the sync status card into the sidebar footer ([#2311](https://github.com/Auxx-Ai/auxx-ai/issues/2311)) ([a3a647a](https://github.com/Auxx-Ai/auxx-ai/commit/a3a647af0a3ded073978bf2d75a55d326ce53b92))
* **conditions:** a between date operator across every condition consumer ([#2365](https://github.com/Auxx-Ai/auxx-ai/issues/2365)) ([643a13d](https://github.com/Auxx-Ai/auxx-ai/commit/643a13d8a2e1c24d86d21b657ba19ee8b2eeac69))
...
* **costing:** first-standard pricing runs as pricePartsJob on the worker ([#2407](https://github.com/Auxx-Ai/auxx-ai/issues/2407)) ([d840ba1](https://github.com/Auxx-Ai/auxx-ai/commit/d840ba122882bb25acefe1dcb50dc80892e8f600))
* **costing:** no automatic standard costs; typed, roll and UI rules (09 D-SC1..D-SC7) ([#2399](https://github.com/Auxx-Ai/auxx-ai/issues/2399)) ([d56ad81](https://github.com/Auxx-Ai/auxx-ai/commit/d56ad81dffd729703d0b26f5d97cf24fe3d2b104))
* **data-connectors:** a backfill that reaches the ingest ceiling continues on its own ([#2317](https://github.com/Auxx-Ai/auxx-ai/issues/2317)) ([ded0383](https://github.com/Auxx-Ai/auxx-ai/commit/ded038375ac7d1322590bf0ce12b91bb2f36be1e))
* **data-connectors:** narrowed fetches — the record filter reaches the app's query (v13) ([#2368](https://github.com/Auxx-Ai/auxx-ai/issues/2368)) ([e8ce0e5](https://github.com/Auxx-Ai/auxx-ai/commit/e8ce0e54e31c0a8e529bbfda0ba4bee8557497a0))
* **data-connectors:** sink mints option keys, app record filters, guest party repoint on receipts ([#2318](https://github.com/Auxx-Ai/auxx-ai/issues/2318)) ([5f5157f](https://github.com/Auxx-Ai/auxx-ai/commit/5f5157fbf0cabe349dd1994409f1ffa967137c9c))
* **data-connectors:** v14 typed query — every fetch is a typed query ([#2391](https://github.com/Auxx-Ai/auxx-ai/issues/2391)) ([766440f](https://github.com/Auxx-Ai/auxx-ai/commit/766440f9e375902a01762f3628c2c25bf30d5f43))
...
* **events:** replay the field-hook chain from the committed scope (events 10 R1–R3) ([#2283](https://github.com/Auxx-Ai/auxx-ai/issues/2283)) ([00b4d05](https://github.com/Auxx-Ai/auxx-ai/commit/00b4d055a1f8178de91ef549b7ccf6438e77edf4))
* **icons:** one palette for the entity definitions, colour is the accounting axis ([#2284](https://github.com/Auxx-Ai/auxx-ai/issues/2284)) ([b1c5175](https://github.com/Auxx-Ai/auxx-ai/commit/b1c517519d686224c04f3eb92274c460740f7ee0))
* image URLs into FILE fields from the importer and data connectors, behind a connect-time SSRF guard ([#2339](https://github.com/Auxx-Ai/auxx-ai/issues/2339)) ([458213b](https://github.com/Auxx-Ai/auxx-ai/commit/458213b5915ca2f87e918a272e0591a872dd164b))
* **inventory:** set count — dated anchor, re-anchor, repeatable opening difference (111 X4) ([#2372](https://github.com/Auxx-Ai/auxx-ai/issues/2372)) ([78ed60b](https://github.com/Auxx-Ai/auxx-ai/commit/78ed60b031239c9812c506f25a29251cc2d776d4))
* **inventory:** the inventory ledger under MRP — the floor, pending cost, the pricer (111 X1–X3) ([#2370](https://github.com/Auxx-Ai/auxx-ai/issues/2370)) ([677402d](https://github.com/Auxx-Ai/auxx-ai/commit/677402d2bbde1e3636c5aa95b3df49a726f7b02c))
...
* line name links to its source record; connector re-binds kept records via RecordIdentity ([#2337](https://github.com/Auxx-Ai/auxx-ai/issues/2337)) ([36e0656](https://github.com/Auxx-Ai/auxx-ai/commit/36e06561e1aa503d9202688acd389efa8ab3d95e))
* **line-builder:** drill-in icon badge to a line's part or catalog item ([#2331](https://github.com/Auxx-Ai/auxx-ai/issues/2331)) ([16aefc3](https://github.com/Auxx-Ai/auxx-ai/commit/16aefc3c9b49ac257ade720b774e4d8c48a16721))
* **mail:** priority, needs-reply, sentiment and spam indicators in the thread header and list rows ([#2351](https://github.com/Auxx-Ai/auxx-ai/issues/2351)) ([224f0e2](https://github.com/Auxx-Ai/auxx-ai/commit/224f0e2eb797a983d350b1084342dd4b7e1cee58))
* **mail:** set priority, needs reply and sentiment by hand from the thread header and bulk toolbar ([#2352](https://github.com/Auxx-Ai/auxx-ai/issues/2352)) ([3a762d5](https://github.com/Auxx-Ai/auxx-ai/commit/3a762d5d14ed2d459fa0884b562a41a6827b9c42))
* **mrp:** position chart tweens its scales; shared paginated legend ([#2406](https://github.com/Auxx-Ai/auxx-ai/issues/2406)) ([bdaa6a9](https://github.com/Auxx-Ai/auxx-ai/commit/bdaa6a981b977d41e264634804567acc520fa773))
* **mrp:** supplier horizon and delivery record charts on the Purchasing tab ([#2408](https://github.com/Auxx-Ai/auxx-ai/issues/2408)) ([14e4fb5](https://github.com/Auxx-Ai/auxx-ai/commit/14e4fb5c346ca973e14f9944148e29acd638b5fb))
* **mrp:** the movement mirror, the plan run and the Manage segment (plans/mrp/08, 07) ([#2371](https://github.com/Auxx-Ai/auxx-ai/issues/2371)) ([b9b7893](https://github.com/Auxx-Ai/auxx-ai/commit/b9b7893eb47a04ea1354f503c161f2034c451b27))
* **orders:** fulfillments on the order drawer, shipped lines on the fulfillment ([#2323](https://github.com/Auxx-Ai/auxx-ai/issues/2323)) ([c3225eb](https://github.com/Auxx-Ai/auxx-ai/commit/c3225eb5521ba30b8fbd05044c0aafd3ff1653e0))
* **parts:** Parts & Services — fold the catalog item into the part (107) ([#2354](https://github.com/Auxx-Ai/auxx-ai/issues/2354)) ([a011d5e](https://github.com/Auxx-Ai/auxx-ai/commit/a011d5ea08989dd101d22b30709b3e73fa66acb2))
...
* **products:** unlisted product status (Shopify UNLISTED) ([#2363](https://github.com/Auxx-Ai/auxx-ai/issues/2363)) ([294f58d](https://github.com/Auxx-Ai/auxx-ai/commit/294f58d6c3fefe583751a609cb61974dadb12c7d))
...
* **purchasing:** purchased services post to a default role; services skip receiving (107 §9) ([#2356](https://github.com/Auxx-Ai/auxx-ai/issues/2356)) ([ec64bbf](https://github.com/Auxx-Ai/auxx-ai/commit/ec64bbf8c6b0f2f9004ee798faf61dae11293b9d))
* **records:** open synced records in their source app from the badge ([#2292](https://github.com/Auxx-Ai/auxx-ai/issues/2292)) ([b52dbf4](https://github.com/Auxx-Ai/auxx-ai/commit/b52dbf470077dd3ae4e58838b223e7d97af75095))
* **set-counts:** read a never-counted part's on-hand (not received / N built) ([#2403](https://github.com/Auxx-Ai/auxx-ai/issues/2403)) ([84a7889](https://github.com/Auxx-Ai/auxx-ai/commit/84a788965aba2df47dfc8083dc92947baef95170))
* **sidebar:** unified rearrangeable sidebar with groups, folders and hidden items ([#2402](https://github.com/Auxx-Ai/auxx-ai/issues/2402)) ([8a25276](https://github.com/Auxx-Ai/auxx-ai/commit/8a25276f904dd8b1bc4e038bafcc8b4c422b2915))
...
* **ui:** resizable, collapsible secondary sidebar ([#2309](https://github.com/Auxx-Ai/auxx-ai/issues/2309)) ([299a4a7](https://github.com/Auxx-Ai/auxx-ai/commit/299a4a71693bcf43036540a0eebca7271bbe611d))
* **web:** opening counts toolbar, MRP settings under General, check as default radio ([#2376](https://github.com/Auxx-Ai/auxx-ai/issues/2376)) ([276d2fb](https://github.com/Auxx-Ai/auxx-ai/commit/276d2fb9319197e549c3c5a99c9348fbcdd5a05f))
* **web:** set counts, the opening inventory difference screen, backflush (111 X4/X5 web) ([#2374](https://github.com/Auxx-Ai/auxx-ai/issues/2374)) ([b01fe65](https://github.com/Auxx-Ai/auxx-ai/commit/b01fe65d17d34d9423176719e202a09b023dadec))
...
* **accounting:** a create that lands and then fails its read-back is withdrawable ([#2248](https://github.com/Auxx-Ai/auxx-ai/issues/2248)) ([7c769c3](https://github.com/Auxx-Ai/auxx-ai/commit/7c769c35b0a39ecead742ff85ceac5195dc8a9ae))
...
* **accounting:** a reversal leaves only with its original; Reverse waits for the provider ([#2322](https://github.com/Auxx-Ai/auxx-ai/issues/2322)) ([27b8907](https://github.com/Auxx-Ai/auxx-ai/commit/27b890718925d91a0945026b7a1bc49893d235f7))
...
* **accounting:** clearing role no longer requires a clearing subtype; mapping suggestion UI polish ([#2346](https://github.com/Auxx-Ai/auxx-ai/issues/2346)) ([dc529e6](https://github.com/Auxx-Ai/auxx-ai/commit/dc529e68ece19eacc27d6dbaba45729145933014))
* **accounting:** filter and paginate manual deposits ([#2297](https://github.com/Auxx-Ai/auxx-ai/issues/2297)) ([af2efd8](https://github.com/Auxx-Ai/auxx-ai/commit/af2efd8aca1b4335a00bf3e2fda43e1eb442dd2d))
* **accounting:** gateway setup follow-ups — clearing subtype, validate first, handle suggestions ([#2320](https://github.com/Auxx-Ai/auxx-ai/issues/2320)) ([4f54ded](https://github.com/Auxx-Ai/auxx-ai/commit/4f54ded19603924df4bfef28f084ba48898b11c7))
* **accounting:** label stock movement links ([#2295](https://github.com/Auxx-Ai/auxx-ai/issues/2295)) ([bfb95c0](https://github.com/Auxx-Ai/auxx-ai/commit/bfb95c028593561eac396e88fc97511a7b8f2f75))
* **accounting:** list panes fill their height; empty gateway editor uses EmptySection ([#2345](https://github.com/Auxx-Ai/auxx-ai/issues/2345)) ([5638ea2](https://github.com/Auxx-Ai/auxx-ai/commit/5638ea2bf1cdb108e00c5345a62cc5f22880f357))
* **accounting:** one inventory entry per relief run, not per fulfillment ([#2329](https://github.com/Auxx-Ai/auxx-ai/issues/2329)) ([fcf479a](https://github.com/Auxx-Ai/auxx-ai/commit/fcf479a5e4f269489db349c93759498b73af1580))
* **accounting:** outbox rows read like the drafts panel ([#2267](https://github.com/Auxx-Ai/auxx-ai/issues/2267)) ([4981b91](https://github.com/Auxx-Ai/auxx-ai/commit/4981b91dfd24fb8be5671416bbbc636e72d2032f))
* **accounting:** re-post matcher-reversed payouts from stored data; QuickBooks-safe names ([#2327](https://github.com/Auxx-Ai/auxx-ai/issues/2327)) ([c173f04](https://github.com/Auxx-Ai/auxx-ai/commit/c173f04edcb92197595ef6c327e72090ac531bee))
* **accounting:** read the build range to exhaustion, scope the rollback block to one book ([#2289](https://github.com/Auxx-Ai/auxx-ai/issues/2289)) ([8882c09](https://github.com/Auxx-Ai/auxx-ai/commit/8882c09573a1b5a68c15287dc06c3d2145066830))
...
* **accounting:** the guest reaches credit memos, and a clause on a field that never existed (79 G5) ([#2287](https://github.com/Auxx-Ai/auxx-ai/issues/2287)) ([3812acd](https://github.com/Auxx-Ai/auxx-ai/commit/3812acda20f108a6d7c4ecc8c146893f159e29bf))
...
* **accounting:** the wizard drive's findings — cache events, chart loader, bulk QuickBooks link (97) ([#2316](https://github.com/Auxx-Ai/auxx-ai/issues/2316)) ([9eb2e56](https://github.com/Auxx-Ai/auxx-ai/commit/9eb2e56cc68d2cdf1997b976de7797daab9d65dd))
...
* **accounting:** what the 110 drive found — pass heartbeat, batch billing, degraded cap, FK indexes ([#2367](https://github.com/Auxx-Ai/auxx-ai/issues/2367)) ([1222812](https://github.com/Auxx-Ai/auxx-ai/commit/122281293e57bfd3ac1843bad3832bca6432892a))
* **auth:** 2FA table mapping; better-auth 1.6.33, drizzle-orm 0.45.2 ([#2386](https://github.com/Auxx-Ai/auxx-ai/issues/2386)) ([0cc7e2c](https://github.com/Auxx-Ai/auxx-ai/commit/0cc7e2c9df8d8c66f820a829c950064190bb8780))
* **auth:** upgrade better-auth to 1.5.6 to stop the daily logout ([#2379](https://github.com/Auxx-Ai/auxx-ai/issues/2379)) ([b506c87](https://github.com/Auxx-Ai/auxx-ai/commit/b506c878d71eed0041caeec1d6dad5a9b0f6c5f5))
* **builds:** backflush never rolls a standard cost ([#2397](https://github.com/Auxx-Ai/auxx-ai/issues/2397)) ([5c0e5df](https://github.com/Auxx-Ai/auxx-ai/commit/5c0e5df22fbc4efce304c69c489d5148a527c154))
...
* **connectors:** show app logos and Stripe mark on connector cards ([#2355](https://github.com/Auxx-Ai/auxx-ai/issues/2355)) ([d32b85a](https://github.com/Auxx-Ai/auxx-ai/commit/d32b85ae87d994b0a6b959bfb2947fe775e36211))
* **costing:** pricer claims pending rows FOR UPDATE; sweep decides by what is still pending ([#2405](https://github.com/Auxx-Ai/auxx-ai/issues/2405)) ([4b015b4](https://github.com/Auxx-Ai/auxx-ai/commit/4b015b47e86d9d9c9a97fced0bd093bbfbf515ad))
...
* **data-connectors:** pass an app's rateLimited through the lambda executor ([#2362](https://github.com/Auxx-Ai/auxx-ai/issues/2362)) ([d4e9738](https://github.com/Auxx-Ai/auxx-ai/commit/d4e973899376b858126d7d397b745e9e76836e1e))
* **data-connectors:** refresh and re-import no longer apply the accounting cutover ([#2369](https://github.com/Auxx-Ai/auxx-ai/issues/2369)) ([e78be70](https://github.com/Auxx-Ai/auxx-ai/commit/e78be7067eed9a933acbaea307b20141ab745c0a))
* **data-connectors:** retire fan-out children a parent no longer carries ([#2296](https://github.com/Auxx-Ai/auxx-ai/issues/2296)) ([7f84b2f](https://github.com/Auxx-Ai/auxx-ai/commit/7f84b2f2b1b0d75af6192e1d471d1fda8e427f0b))
* **database:** index the foreign keys record deletes and money reads scan; reset-org-books clears the money model ([#2314](https://github.com/Auxx-Ai/auxx-ai/issues/2314)) ([18ea681](https://github.com/Auxx-Ai/auxx-ai/commit/18ea68127fa048d8e7ad122d16a4f9c8642d21d2))
...
* **files:** release FILE-field images when a record is deleted ([#2360](https://github.com/Auxx-Ai/auxx-ai/issues/2360)) ([2934e78](https://github.com/Auxx-Ai/auxx-ai/commit/2934e7897167db46223ffadf229eb3a893416837))
* **import:** resolve cells per column, not across columns ([#2332](https://github.com/Auxx-Ai/auxx-ai/issues/2332)) ([5265664](https://github.com/Auxx-Ai/auxx-ai/commit/526566443a7cf3c698ade015442e8e8e7d57d986))
* **import:** round excess money decimals instead of rejecting the cell ([#2383](https://github.com/Auxx-Ai/auxx-ai/issues/2383)) ([488d1b6](https://github.com/Auxx-Ai/auxx-ai/commit/488d1b69662e87fc458ffaacbd409fb69ca4cf5d))
* **import:** value overrides stick, recount errors and re-plan ([#2380](https://github.com/Auxx-Ai/auxx-ai/issues/2380)) ([f313556](https://github.com/Auxx-Ai/auxx-ai/commit/f3135562c7f2c30afc90b15e2963f429cae40ef2))
* **jobs:** bullmq job ids without ':' for accounting recovery and connect-and-go ([#2359](https://github.com/Auxx-Ai/auxx-ai/issues/2359)) ([39e62b8](https://github.com/Auxx-Ai/auxx-ai/commit/39e62b8703c28b5d4de85be15853a0aee4b523ba))
...
* **lib:** type the provider mock's input so the lib typecheck ratchet passes on main ([#2271](https://github.com/Auxx-Ai/auxx-ai/issues/2271)) ([d3a93c1](https://github.com/Auxx-Ai/auxx-ai/commit/d3a93c17f66a2571a2f4b7f88f8f970d63fccacf))
* **mail:** triage badge and menu polish ([#2353](https://github.com/Auxx-Ai/auxx-ai/issues/2353)) ([fe3f11b](https://github.com/Auxx-Ai/auxx-ai/commit/fe3f11b4264dade89c28de853696465eb025ead1))
* **mrp:** 111 browser pass fixes and book-zone day handling ([#2377](https://github.com/Auxx-Ai/auxx-ai/issues/2377)) ([75d2e30](https://github.com/Auxx-Ai/auxx-ai/commit/75d2e302439f46ab2c57e1a90c8f2af8bee7eece))
* **mrp:** first browser pass and the count re-anchor (plans/mrp/09) ([#2375](https://github.com/Auxx-Ai/auxx-ai/issues/2375)) ([ee6f2a6](https://github.com/Auxx-Ai/auxx-ai/commit/ee6f2a670fec498320dd576a4d2df9d267e582aa))
* **mrp:** position chart per-bucket bars and paging; negative on hand is no stockout ([#2394](https://github.com/Auxx-Ai/auxx-ai/issues/2394)) ([ba57d25](https://github.com/Auxx-Ai/auxx-ai/commit/ba57d250653694226a68beaf798fd6ab27a4a477))
* **mrp:** split the supplier blocks, empty states, row hovers ([#2384](https://github.com/Auxx-Ai/auxx-ai/issues/2384)) ([1508852](https://github.com/Auxx-Ai/auxx-ai/commit/1508852fad447c435dfc3a16efe3a604abee9386))
* **realtime:** connector syncs stop flooding per-record events ([#2382](https://github.com/Auxx-Ai/auxx-ai/issues/2382)) ([591fcd6](https://github.com/Auxx-Ai/auxx-ai/commit/591fcd6d0968f082d46713dc97e3e86bb26b525c))
* **realtime:** quiet writes with a covering publish send no per-record frames ([#2392](https://github.com/Auxx-Ai/auxx-ai/issues/2392)) ([b318153](https://github.com/Auxx-Ai/auxx-ai/commit/b318153003ba27ce14e3b7de3947e8fc72d9bc10))
* **records:** show the source badge on peeked drawer frames ([#2298](https://github.com/Auxx-Ai/auxx-ai/issues/2298)) ([97925e6](https://github.com/Auxx-Ai/auxx-ai/commit/97925e697b0650e59ec7f045c536b707ab180522))
* **scripts:** reset-org-books clears MRP runs, vendor payments and backflush ([#2381](https://github.com/Auxx-Ai/auxx-ai/issues/2381)) ([dd301c9](https://github.com/Auxx-Ai/auxx-ai/commit/dd301c97a92d759324fcdc49cc2ed21f8d190d19))
* **security:** pin connection base-URL hosts and guard raw TCP clients ([#2340](https://github.com/Auxx-Ai/auxx-ai/issues/2340)) ([a190f1a](https://github.com/Auxx-Ai/auxx-ai/commit/a190f1a9015da9af73d564e78549ca4d0ac6c4db))
* **sync:** finalize integrity passes survive a worker kill ([#2388](https://github.com/Auxx-Ai/auxx-ai/issues/2388)) ([bc54c1a](https://github.com/Auxx-Ai/auxx-ai/commit/bc54c1a8cb6ffff3a6e41bae1e1bdad1a64314a5))
...
* **web:** a failed catch-up chunk no longer blanks its cells ([#2385](https://github.com/Auxx-Ai/auxx-ai/issues/2385)) ([664e20b](https://github.com/Auxx-Ai/auxx-ai/commit/664e20bea3eab68b6a02b7b5e5c7ff768f51e955))
* **web:** drop Refresh evidence, gateway feeds move into the field panel ([#2387](https://github.com/Auxx-Ai/auxx-ai/issues/2387)) ([f898687](https://github.com/Auxx-Ai/auxx-ai/commit/f898687ed080ca13ba3a1ede31aa81df7bcab313))
* **web:** give vendor credits its records route, so the sidebar link resolves ([#2285](https://github.com/Auxx-Ai/auxx-ai/issues/2285)) ([e60e6fe](https://github.com/Auxx-Ai/auxx-ai/commit/e60e6fee320abc15ce4676178de6614b790064ea))
* **web:** one backflush banner on set counts, not an alert per row ([#2390](https://github.com/Auxx-Ai/auxx-ai/issues/2390)) ([95716d0](https://github.com/Auxx-Ai/auxx-ai/commit/95716d06e4882e421f863be4077881ceff69bb75))
* **web:** settlements badges, gateway dialog, parts settings and filter pickers UI pass ([#2378](https://github.com/Auxx-Ai/auxx-ai/issues/2378)) ([101703f](https://github.com/Auxx-Ai/auxx-ai/commit/101703fbf4529e1d7b2e1d8a7959f05bd1eae6e3))
...
* **builds:** batched movement writes and a one-pass completed build ([#2396](https://github.com/Auxx-Ai/auxx-ai/issues/2396)) ([443981c](https://github.com/Auxx-Ai/auxx-ai/commit/443981c233d9939b7c6ee37a44cefa37cb889db1))
* **field-values:** inverse sync reads only the pairs it adds; field ids from the org cache ([#2398](https://github.com/Auxx-Ai/auxx-ai/issues/2398)) ([339d28e](https://github.com/Auxx-Ai/auxx-ai/commit/339d28e19702850795e85093217b984bbe677ce7))
* **inventory:** relief, salvage and revalue on the batched movement writer (12b) ([#2404](https://github.com/Auxx-Ai/auxx-ai/issues/2404)) ([3ac9622](https://github.com/Auxx-Ai/auxx-ai/commit/3ac962276fee96f957f54d24986e9f49266343fe))
* **records:** batched record creates; backflush writes a slice as one batch ([#2401](https://github.com/Auxx-Ai/auxx-ai/issues/2401)) ([a1508cb](https://github.com/Auxx-Ai/auxx-ai/commit/a1508cb2fb9ac90a5086b4487327857f13079089))
* **records:** display columns in the create insert; no empty probe on a fresh instance ([#2393](https://github.com/Auxx-Ai/auxx-ai/issues/2393)) ([9a143ef](https://github.com/Auxx-Ai/auxx-ai/commit/9a143ef3a9566b249fc100d644d0b80875829a9e))
...
* **accounting:** give the payout entry a trigger, and a home for money auxx did not take ([#2058](https://github.com/Auxx-Ai/auxx-ai/issues/2058)) ([b9373ab](https://github.com/Auxx-Ai/auxx-ai/commit/b9373abeab8e510474853078549fb529b15f62b8))
...
* **accounting:** the write-off guard, the JE attachment, TIN masking and the review stats ([#2057](https://github.com/Auxx-Ai/auxx-ai/issues/2057)) ([0e915a2](https://github.com/Auxx-Ai/auxx-ai/commit/0e915a2dd255e0e33325df0f245a19ffedcc5acd))
...
* **accounting:** gl_posting entity and the QuickBooks journal-entry poster ([#1865](https://github.com/Auxx-Ai/auxx-ai/issues/1865)) ([508fe99](https://github.com/Auxx-Ai/auxx-ai/commit/508fe996297c2f2154a8637204f8f1726631dc1f))
* **ai-autofill:** widen eligible field types and fix options patch loss ([#1787](https://github.com/Auxx-Ai/auxx-ai/issues/1787)) ([eef351d](https://github.com/Auxx-Ai/auxx-ai/commit/eef351d095bf86752b20037737d440107bba43bf))
* **catalog:** relabel to Catalog Items and give the catalog a first-class route ([#1849](https://github.com/Auxx-Ai/auxx-ai/issues/1849)) ([a445f19](https://github.com/Auxx-Ai/auxx-ai/commit/a445f1920ceb77b921ba28dac63fe2aa927ee9b8))
* **connections:** gate bring-your-own OAuth client on a feature key ([#1795](https://github.com/Auxx-Ai/auxx-ai/issues/1795)) ([bc13808](https://github.com/Auxx-Ai/auxx-ai/commit/bc13808699471d3d95186f4f6b3a498a249e852e))
* **connectors:** recommend app sources from published, verified apps ([#1780](https://github.com/Auxx-Ai/auxx-ai/issues/1780)) ([8679566](https://github.com/Auxx-Ai/auxx-ai/commit/86795660d44bdf00df041e4c327a5bbb3665c5af))
* **crud:** bind a write session with origin to the unified handler ([#1800](https://github.com/Auxx-Ai/auxx-ai/issues/1800)) ([8f5b688](https://github.com/Auxx-Ai/auxx-ai/commit/8f5b68845b842c54080bd8b5f72174158db808e5))
* **crud:** bulk archives emit tier-2 delta frames instead of per-record ([#1812](https://github.com/Auxx-Ai/auxx-ai/issues/1812)) ([f898dca](https://github.com/Auxx-Ai/auxx-ai/commit/f898dcad049ce8c84039d184d73e5a1bcb8401a8))
* **custom-fields:** cascade option deletes to their stored values ([#1791](https://github.com/Auxx-Ai/auxx-ai/issues/1791)) ([3ee3415](https://github.com/Auxx-Ai/auxx-ai/commit/3ee3415ec965af7a3677ef1b3be8334a6d0ec375))
* **data-connectors:** construct sync write sessions for connector and importer ([#1803](https://github.com/Auxx-Ai/auxx-ai/issues/1803)) ([12df441](https://github.com/Auxx-Ai/auxx-ai/commit/12df4418ef8cedea54a533f452367a565fb64420))
* **database:** stamp EntityInstance.updatedAt explicitly instead of $onUpdate ([#1805](https://github.com/Auxx-Ai/auxx-ai/issues/1805)) ([c21e5fc](https://github.com/Auxx-Ai/auxx-ai/commit/c21e5fcfd7574ab1f50690fcad4031bc720b1fa5))
* **events:** add the sync finalize pass with count-based lane selection ([#1806](https://github.com/Auxx-Ai/auxx-ai/issues/1806)) ([e4d1893](https://github.com/Auxx-Ai/auxx-ai/commit/e4d18937d8b08ef28b097b6d26c66b87eafb3c38))
* **events:** add write fan-out door matrix as code ([#1798](https://github.com/Auxx-Ai/auxx-ai/issues/1798)) ([f9efe2d](https://github.com/Auxx-Ai/auxx-ai/commit/f9efe2d3b5e2ebe55859f5ec0dcbd5c6b4712cad))
* **events:** buffer in-transaction writes and replay their doors post-commit ([#1826](https://github.com/Auxx-Ai/auxx-ai/issues/1826)) ([014f3ae](https://github.com/Auxx-Ai/auxx-ai/commit/014f3ae8afe3358e23d6cba7f559a73216cbdef0))
* **events:** declare why a silent write is silent, and enforce it ([#1828](https://github.com/Auxx-Ai/auxx-ai/issues/1828)) ([5af8dc3](https://github.com/Auxx-Ai/auxx-ai/commit/5af8dc39b203abb007e11639350762839efdc965))
* **events:** guard large-run workflow dispatch and add integrity batch passes ([#1809](https://github.com/Auxx-Ai/auxx-ai/issues/1809)) ([c5f5268](https://github.com/Auxx-Ai/auxx-ai/commit/c5f52688c0cd77215b5bd9ee8dd6fb9d1579f112))
* **events:** move tier-2 delta capture to the engine, retire producer capture (plan 07 PR 2) ([#1850](https://github.com/Auxx-Ai/auxx-ai/issues/1850)) ([9e5a104](https://github.com/Auxx-Ai/auxx-ai/commit/9e5a104255f72bade2ab980ad1d9f94c11102914))
* **events:** per-field timeline entries for small sync runs ([#1815](https://github.com/Auxx-Ai/auxx-ai/issues/1815)) ([1f1bea7](https://github.com/Auxx-Ai/auxx-ai/commit/1f1bea72bd77a367274d3137dffae748526ad4dd))
* **events:** unconditional two-tier sync capture (plan 07 PR 1, closes H-1) ([#1846](https://github.com/Auxx-Ai/auxx-ai/issues/1846)) ([53b9a3d](https://github.com/Auxx-Ai/auxx-ai/commit/53b9a3d14ea4b2517005acc497d796b484baf860))
* **import:** a resolution-type picker, and make changing one take effect ([#1870](https://github.com/Auxx-Ai/auxx-ai/issues/1870)) ([153502a](https://github.com/Auxx-Ai/auxx-ai/commit/153502a76fee7b483339f1aa741c095291ee4d86))
* **import:** currency resolution type so prices with cents can be imported ([#1867](https://github.com/Auxx-Ai/auxx-ai/issues/1867)) ([f1fc681](https://github.com/Auxx-Ai/auxx-ai/commit/f1fc6813ace843392591cfb8722b250df3e66a45))
* **import:** let a select column create the options it names ([#1869](https://github.com/Auxx-Ai/auxx-ai/issues/1869)) ([7201001](https://github.com/Auxx-Ai/auxx-ai/commit/720100174066474ca1465e6840d53ec9286724ba))
* **import:** update strategy with identifier matching and batched lookups ([#1793](https://github.com/Auxx-Ai/auxx-ai/issues/1793)) ([faee48b](https://github.com/Auxx-Ai/auxx-ai/commit/faee48be59cc31b0d6867ecfcb821bb89eb788a1))
* **parts:** add a buy-vs-build costing card to the part drawer ([#1834](https://github.com/Auxx-Ai/auxx-ai/issues/1834)) ([4e8b200](https://github.com/Auxx-Ai/auxx-ai/commit/4e8b20017eeb9766da3a2902f2d2ee8b65d89655))
* **parts:** sellable toggle and pricing row on the part drawer ([#1848](https://github.com/Auxx-Ai/auxx-ai/issues/1848)) ([d661664](https://github.com/Auxx-Ai/auxx-ai/commit/d661664f812f0e47c3f30f74eb3a42686c41215b))
* **parts:** show which supplier the part cost came from ([#1833](https://github.com/Auxx-Ai/auxx-ai/issues/1833)) ([bd1bd46](https://github.com/Auxx-Ai/auxx-ai/commit/bd1bd4671697595d0f8d7c7d676bd98a41c9bc0c))
* **parts:** split part cost into purchase, roll-up and source ([#1830](https://github.com/Auxx-Ai/auxx-ai/issues/1830)) ([379866c](https://github.com/Auxx-Ai/auxx-ai/commit/379866c81c88c5f6064cd20068ce03b4a0014481))
* **pickers:** edit an option's colour from the record-side picker ([#1792](https://github.com/Auxx-Ai/auxx-ai/issues/1792)) ([7a3c429](https://github.com/Auxx-Ai/auxx-ai/commit/7a3c4296e2112f049a73ed6d69152d18f77fe75b))
* **products:** add the product family entity ([#1840](https://github.com/Auxx-Ai/auxx-ai/issues/1840)) ([5df3ad6](https://github.com/Auxx-Ai/auxx-ai/commit/5df3ad652e9080fd6133975c6aa18f9ada562651))
* **products:** product detail page, family card and finished-good suggestion ([#1845](https://github.com/Auxx-Ai/auxx-ai/issues/1845)) ([42248f9](https://github.com/Auxx-Ai/auxx-ai/commit/42248f92986e6511aaec35128b66ca50c36a8c45))
* **realtime:** add batched records:changed delta frames and run:completed ([#1801](https://github.com/Auxx-Ai/auxx-ai/issues/1801)) ([332d388](https://github.com/Auxx-Ai/auxx-ai/commit/332d38831763baebb9c45007f3b603cbc55fbd6a))
* **sdk:** widen EntityRefKind with part and product ([#1837](https://github.com/Auxx-Ai/auxx-ai/issues/1837)) ([31e5b22](https://github.com/Auxx-Ai/auxx-ai/commit/31e5b22ee4901871c2d02ecf45e27358227bf96f))
* **seed:** declare seed and ingest write sessions, retire skipEvents there ([#1804](https://github.com/Auxx-Ai/auxx-ai/issues/1804)) ([7b52c96](https://github.com/Auxx-Ai/auxx-ai/commit/7b52c96f2f54a0bfff1fbb3d1ca556f9c2b204c9))
* **workflow:** add builder-specific kopilot empty-chat suggestions ([#1759](https://github.com/Auxx-Ai/auxx-ai/issues/1759)) ([a9bbb5c](https://github.com/Auxx-Ai/auxx-ai/commit/a9bbb5c0cebfad12ba3035f37f586401054560c4))
* **workflow:** give the draft save path an opinion about what a change is ([#1770](https://github.com/Auxx-Ai/auxx-ai/issues/1770)) ([af40aa0](https://github.com/Auxx-Ai/auxx-ai/commit/af40aa05ed4299ac6e8d1241defffa2f0ac78f3b))
* **workflow:** let more node types handle their own failures ([#1767](https://github.com/Auxx-Ai/auxx-ai/issues/1767)) ([b9f93c6](https://github.com/Auxx-Ai/auxx-ai/commit/b9f93c675728f37a6c902e8c098fd1604d1cb175))
* **workflow:** migrate the webhook and webhook-endpoint nodes to the catalog ([#1760](https://github.com/Auxx-Ai/auxx-ai/issues/1760)) ([3657205](https://github.com/Auxx-Ai/auxx-ai/commit/3657205acaeea01719586ffc74d20c6504a52100))
* **workflow:** name the node in history entries, with a reusable node badge ([#1777](https://github.com/Auxx-Ai/auxx-ai/issues/1777)) ([21ee583](https://github.com/Auxx-Ai/auxx-ai/commit/21ee5838c665fa6178ad3f4f6126fc03b89c1a8d))
* **workflow:** rename the form-input enum type to select, add a multiple toggle ([#1762](https://github.com/Auxx-Ai/auxx-ai/issues/1762)) ([826075b](https://github.com/Auxx-Ai/auxx-ai/commit/826075b34caa1ebd28af4a13a115d4ff2c3987fe))
* **workflow:** scope node outputs to the branch that reaches them ([#1769](https://github.com/Auxx-Ai/auxx-ai/issues/1769)) ([6fef26a](https://github.com/Auxx-Ai/auxx-ai/commit/6fef26ad729035a51f4595786c88035e53a0fc55))
* **workflows:** create from scratch without a dialog ([#1761](https://github.com/Auxx-Ai/auxx-ai/issues/1761)) ([51b7158](https://github.com/Auxx-Ai/auxx-ai/commit/51b7158199ba92cc99bc23a2cce19f3ea7b998d6))


### Bug Fixes

* **auth:** end email signup on a verify step instead of the login form ([#1757](https://github.com/Auxx-Ai/auxx-ai/issues/1757)) ([b8f0d04](https://github.com/Auxx-Ai/auxx-ai/commit/b8f0d04d3d11ced9351aee995b8a1ecee005fbd7))
* **billing:** sync shopify plan changes to the app ui ([#1855](https://github.com/Auxx-Ai/auxx-ai/issues/1855)) ([5308408](https://github.com/Auxx-Ai/auxx-ai/commit/530840824b2f6afc192d0af20d026e2e3744445d))
* **build:** unblock app review submission on connection oauth checks ([#1755](https://github.com/Auxx-Ai/auxx-ai/issues/1755)) ([dd8960b](https://github.com/Auxx-Ai/auxx-ai/commit/dd8960be704a5f3ee3c7d2a3de061326759d6f4f))
* **connectors:** bind contributing mappings under named array roots ([#1835](https://github.com/Auxx-Ai/auxx-ai/issues/1835)) ([87d014b](https://github.com/Auxx-Ai/auxx-ai/commit/87d014b24244fbc66e65554df76e3fae8f86d3c7))
* **connectors:** project stored rootPaths and parent contributing mappings ([#1839](https://github.com/Auxx-Ai/auxx-ai/issues/1839)) ([4781444](https://github.com/Auxx-Ai/auxx-ai/commit/4781444d57ea1c723d5d3b1460b4de3dbfce8c99))
* **data-connectors:** split a connector's comma string into separate tag values ([#1778](https://github.com/Auxx-Ai/auxx-ai/issues/1778)) ([15519a4](https://github.com/Auxx-Ai/auxx-ai/commit/15519a454b2c4e9234bb6e514477a85a6e9777f8))
* **data-connectors:** stop the relationship pass rewriting unchanged edges ([#1797](https://github.com/Auxx-Ai/auxx-ai/issues/1797)) ([de978f0](https://github.com/Auxx-Ai/auxx-ai/commit/de978f05e143f85921b4faef2bf76e7ae012599e))
* **dynamic-table:** copy select cells as labels so cross-column paste matches ([#1789](https://github.com/Auxx-Ai/auxx-ai/issues/1789)) ([e13f6d7](https://github.com/Auxx-Ai/auxx-ai/commit/e13f6d74ea4b28e7267d783daa202671e620f249))
* **dynamic-table:** make relationship-path columns read-only ([#1781](https://github.com/Auxx-Ai/auxx-ai/issues/1781)) ([452460a](https://github.com/Auxx-Ai/auxx-ai/commit/452460a44fb1ba3bfc13912bd9fdea85b6ebf84d))
* **dynamic-table:** stop dnd keyboard sensor from swallowing dialog keys ([#1786](https://github.com/Auxx-Ai/auxx-ai/issues/1786)) ([243b88d](https://github.com/Auxx-Ai/auxx-ai/commit/243b88dd124cae88fe8fc402a18bb7a024a81f88))
* **entity-instances:** seed archives skip lastActivityAt; reconcile door ledger ([#1810](https://github.com/Auxx-Ai/auxx-ai/issues/1810)) ([7fc5ade](https://github.com/Auxx-Ai/auxx-ai/commit/7fc5ade2a27512584a70aa9e72eb6b1fb1e7797d))
* **field-values:** skip no-op set writes and delete-of-absent clears ([#1799](https://github.com/Auxx-Ai/auxx-ai/issues/1799)) ([87a2f02](https://github.com/Auxx-Ai/auxx-ai/commit/87a2f0221684ff4e384b4c66818495214fac5c34))
* **fields:** inline tag creation resolves, persists, and stays option-safe ([#1871](https://github.com/Auxx-Ai/auxx-ai/issues/1871)) ([333a76e](https://github.com/Auxx-Ai/auxx-ai/commit/333a76e26d96eb38c302f1ac1ec8f1a62126cc7e))
* **files:** four correctness bugs in the upload path ([#1816](https://github.com/Auxx-Ai/auxx-ai/issues/1816)) ([8a4feb2](https://github.com/Auxx-Ai/auxx-ai/commit/8a4feb2b3347f4870cfa5e07e1f08410ec356c88))
* **files:** pass the recorded bucket when sweeping orphaned storage objects ([#1817](https://github.com/Auxx-Ai/auxx-ai/issues/1817)) ([98619a2](https://github.com/Auxx-Ai/auxx-ai/commit/98619a2a793846e2adc97681a95c891ab44066f2))
* **files:** render an uploaded image preview instead of blanking the avatar ([#1794](https://github.com/Auxx-Ai/auxx-ai/issues/1794)) ([094610e](https://github.com/Auxx-Ai/auxx-ai/commit/094610eed45b47a1e9a02a1be1b7937cfaf0a481))
* **files:** repair multipart uploads, and extract presign and object ops ([#1832](https://github.com/Auxx-Ai/auxx-ai/issues/1832)) ([fa80b72](https://github.com/Auxx-Ai/auxx-ai/commit/fa80b72955a503f0962dd9824e07865a3f71ebb4))
* **files:** resolve avatar thumbnails at save time and harden file downloads ([#1796](https://github.com/Auxx-Ai/auxx-ai/issues/1796)) ([5701b54](https://github.com/Auxx-Ai/auxx-ai/commit/5701b54cbcb78c3a7578c0eb27540e0f74b32c8a))
* **import:** clearing a review value skips it, and the picker stops offering manage and clear ([#1874](https://github.com/Auxx-Ai/auxx-ai/issues/1874)) ([e8bdeb8](https://github.com/Auxx-Ai/auxx-ai/commit/e8bdeb8a4e01d432570a0a789a71584fb030f42e))
* **import:** live-refresh records during import via records:invalidated ([#1784](https://github.com/Auxx-Ai/auxx-ai/issues/1784)) ([b208e58](https://github.com/Auxx-Ai/auxx-ai/commit/b208e58d5d587ab40bf1a9b82fc48ca832b53451))
* **import:** make sku a usable identifier in every org ([#1788](https://github.com/Auxx-Ai/auxx-ai/issues/1788)) ([2aebd90](https://github.com/Auxx-Ai/auxx-ai/commit/2aebd907648046abeeb2226652ef2926cc34235a))
* **import:** resolve select option lists live, not from the client's snapshot ([#1868](https://github.com/Auxx-Ai/auxx-ai/issues/1868)) ([20f7a74](https://github.com/Auxx-Ai/auxx-ai/commit/20f7a744ba85ed7ca5465b9f774576d87619e5dc))
* **import:** review-values option labels and selector, broadcast minted options live ([#1873](https://github.com/Auxx-Ai/auxx-ai/issues/1873)) ([ff4c3ec](https://github.com/Auxx-Ai/auxx-ai/commit/ff4c3ec950b0f6565d7d82104aee9f6fe859b9d1))
* **ingest:** gate thread:reopened behind historical-mail suppression ([#1811](https://github.com/Auxx-Ai/auxx-ai/issues/1811)) ([6a09698](https://github.com/Auxx-Ai/auxx-ai/commit/6a096988f4c42e1815f822a7ab1d498745d6688f))
* **kopilot:** make the whole composer box focus the editor on click ([#1758](https://github.com/Auxx-Ai/auxx-ai/issues/1758)) ([5ca51f5](https://github.com/Auxx-Ai/auxx-ai/commit/5ca51f5def93c6c643f9f2831c1a4f0f031cc996))
* **money:** stop the pricing engine writing to archived and inactive catalog items ([#1847](https://github.com/Auxx-Ai/auxx-ai/issues/1847)) ([7e9e5d7](https://github.com/Auxx-Ai/auxx-ai/commit/7e9e5d7e82e598836ff69820d14d2bbbf40fa61f))
* **parts:** clear part cost and unit price when their source goes away ([#1824](https://github.com/Auxx-Ai/auxx-ai/issues/1824)) ([10e0d9d](https://github.com/Auxx-Ai/auxx-ai/commit/10e0d9d2b4567c13000aabcaab53b3747fe07375))
* **parts:** importer phase 0 — round bom costs, currency integer floor, optional vendor sku ([#1872](https://github.com/Auxx-Ai/auxx-ai/issues/1872)) ([c70354f](https://github.com/Auxx-Ai/auxx-ai/commit/c70354f74cae4f87ea6931f218056eadb06f3bd9))
* **providers:** give imap the full backfill suppression the oauth lanes have ([#1813](https://github.com/Auxx-Ai/auxx-ai/issues/1813)) ([0a13147](https://github.com/Auxx-Ai/auxx-ai/commit/0a131478fe43482fa7e4f30abd650f53dac4a439))
* **records:** stop double header on tickets and parts import pages ([#1785](https://github.com/Auxx-Ai/auxx-ai/issues/1785)) ([0184d1d](https://github.com/Auxx-Ai/auxx-ai/commit/0184d1dc8730ded292f829897d0d9cc8fa69424c))
* **seed:** stop dropping skipEvents in the modes slot and wire ingest handler deps ([#1802](https://github.com/Auxx-Ai/auxx-ai/issues/1802)) ([f234194](https://github.com/Auxx-Ai/auxx-ai/commit/f2341949652d321d54d5dc49d78807281041232c))
* **ui:** register package-2 so the Products entity renders an icon ([#1864](https://github.com/Auxx-Ai/auxx-ai/issues/1864)) ([fdef7a2](https://github.com/Auxx-Ai/auxx-ai/commit/fdef7a2ce82d371d75af15788abf73b071a4223a))
* **uploader:** give each upload session its own run state, so two sessions stop trading globals (plan 8b) ([#1861](https://github.com/Auxx-Ai/auxx-ai/issues/1861)) ([5f63e58](https://github.com/Auxx-Ai/auxx-ai/commit/5f63e58fbb596dbf9d1ffecf9f9f045dc120d0e7))
* **uploads:** authenticate the session routes, and finish the Tier-1 fixes ([#1818](https://github.com/Auxx-Ai/auxx-ai/issues/1818)) ([7adcbe1](https://github.com/Auxx-Ai/auxx-ai/commit/7adcbe1a0a2926dc0d6ac511181bdd3911bdbbd2))
* **workflow:** account for webhook runs, canonicalize template writes, retire the graph-document legacy ([#1774](https://github.com/Auxx-Ai/auxx-ai/issues/1774)) ([7d344b2](https://github.com/Auxx-Ai/auxx-ai/commit/7d344b2df19c447dbee7ba1e91445913bdfc941a))
* **workflow:** address branches by id so agent wiring stops guessing ([#1765](https://github.com/Auxx-Ai/auxx-ai/issues/1765)) ([a9af65f](https://github.com/Auxx-Ai/auxx-ai/commit/a9af65fc81671c6a37fde1b2a3c80f8918b5c3f9))
* **workflow:** coalesce undo history by identity instead of by time ([#1775](https://github.com/Auxx-Ai/auxx-ai/issues/1775)) ([a6169d2](https://github.com/Auxx-Ai/auxx-ai/commit/a6169d22960d093eaea2f70b68c1e59bf66e4478))
* **workflow:** give an if-else case one identifier and defaultData one meaning ([#1779](https://github.com/Auxx-Ai/auxx-ai/issues/1779)) ([094357c](https://github.com/Auxx-Ai/auxx-ai/commit/094357c3bf9aad28d8e5e090e9a29f2af8387b12))
* **workflow:** give the webhook route the graph key the engine reads ([#1764](https://github.com/Auxx-Ai/auxx-ai/issues/1764)) ([9f5632c](https://github.com/Auxx-Ai/auxx-ai/commit/9f5632c0482c5f7ae28a050f94264a8ed9991796))
* **workflow:** hydrate and dehydrate under one policy on both sides of the wire ([#1771](https://github.com/Auxx-Ai/auxx-ai/issues/1771)) ([b76b7cb](https://github.com/Auxx-Ai/auxx-ai/commit/b76b7cb4adc014b378709eb010d1b8d57b2b01b2))
* **workflow:** let the edge be the only record of a manual trigger's inputs ([#1768](https://github.com/Auxx-Ai/auxx-ai/issues/1768)) ([506c2b1](https://github.com/Auxx-Ai/auxx-ai/commit/506c2b1fab66d98ab0074b864b4dbc46ae9fd3bf))
* **workflow:** make crud fail-only and redraw the substitutes editor ([#1773](https://github.com/Auxx-Ai/auxx-ai/issues/1773)) ([536b10c](https://github.com/Auxx-Ai/auxx-ai/commit/536b10c0b1f18bd54b8bab0043685d3e956a3336))
* **workflow:** make the hydration invariants test the policy that actually ships ([#1772](https://github.com/Auxx-Ai/auxx-ai/issues/1772)) ([0c18abf](https://github.com/Auxx-Ai/auxx-ai/commit/0c18abf14593ce5da9f55a286f0552e2d45543cb))
* **workflow:** meter public-share runs through createWorkflowRun ([#1776](https://github.com/Auxx-Ai/auxx-ai/issues/1776)) ([a871c7c](https://github.com/Auxx-Ai/auxx-ai/commit/a871c7c9140129920d20646cd3c92cb946c9e753))
* **workflow:** publish the declared output contract for form-input nodes ([#1763](https://github.com/Auxx-Ai/auxx-ai/issues/1763)) ([8dea460](https://github.com/Auxx-Ai/auxx-ai/commit/8dea46063411ff2d7eb234515f2b296ca56615e9))
...
* **channels:** graph api seam and 24-hour send window for facebook/instagram ([#1698](https://github.com/Auxx-Ai/auxx-ai/issues/1698)) ([89445d6](https://github.com/Auxx-Ai/auxx-ai/commit/89445d68e1462961487921aed73a7b72b8b5599e))
* **channels:** move outlook inbound mail to graph webhook push ([#1585](https://github.com/Auxx-Ai/auxx-ai/issues/1585)) ([f9f1db1](https://github.com/Auxx-Ai/auxx-ai/commit/f9f1db18022f58375ffcd5e9a7d5d86fe4eae0f1))
* **channels:** rewrite the quo (openphone) channel against the real api ([#1646](https://github.com/Auxx-Ai/auxx-ai/issues/1646)) ([a3d36ca](https://github.com/Auxx-Ai/auxx-ai/commit/a3d36cae33da01d05ccc93a4d4ef24ecdd22191d))
* **channels:** typed reauth send error and composer warning icon ([#1682](https://github.com/Auxx-Ai/auxx-ai/issues/1682)) ([91adccc](https://github.com/Auxx-Ai/auxx-ai/commit/91adccc93a9670e0ccaa2e81c40e3c507fda0ae8))
* **composer:** always-on composer for phone threads, pin From to the thread channel ([#1657](https://github.com/Auxx-Ai/auxx-ai/issues/1657)) ([ad79af5](https://github.com/Auxx-Ai/auxx-ai/commit/ad79af5159d0db8a575b23b929c5ee5d5065a5c2))
* **composer:** drive composer and thread rendering off channel capabilities ([#1654](https://github.com/Auxx-Ai/auxx-ai/issues/1654)) ([f65089e](https://github.com/Auxx-Ai/auxx-ai/commit/f65089ebfd484691dcc1dae4491b97b6350e81e9))
* **composer:** offer a contact's other addresses from the recipient chip ([#1673](https://github.com/Auxx-Ai/auxx-ai/issues/1673)) ([c22bb1a](https://github.com/Auxx-Ai/auxx-ai/commit/c22bb1aaa8e60f9d5560351c28cc807cf71c0125))
* **composer:** offer phone channels in the From picker ([#1652](https://github.com/Auxx-Ai/auxx-ai/issues/1652)) ([caa1a1e](https://github.com/Auxx-Ai/auxx-ai/commit/caa1a1ec672d5cd1233ab0714eb8649d1279d454))
* **composer:** swap the recipient picker onto ranked recipient search ([#1671](https://github.com/Auxx-Ai/auxx-ai/issues/1671)) ([c3e9420](https://github.com/Auxx-Ai/auxx-ai/commit/c3e942051df1b9dde9115f7298e7d9c6569371cd))
* **connectors:** row-level sink semantics for multi-value fields (B1) ([#1621](https://github.com/Auxx-Ai/auxx-ai/issues/1621)) ([01ebfa1](https://github.com/Auxx-Ai/auxx-ai/commit/01ebfa1dcd65c0cc8f4e84869c998d75abe914f4))
* **contacts:** derive city, region and timezone from phone numbers ([#1669](https://github.com/Auxx-Ai/auxx-ai/issues/1669)) ([7d4e699](https://github.com/Auxx-Ai/auxx-ai/commit/7d4e69959568eb31dc89b2f65a72d61216bdb662))
* **database:** ship the messageType partial index migration ([#1688](https://github.com/Auxx-Ai/auxx-ai/issues/1688)) ([0049b7e](https://github.com/Auxx-Ai/auxx-ai/commit/0049b7e08a9ef79ac83bcf150425d5c42a1220e7))
* **fields:** default phone inputs to the org business country ([#1656](https://github.com/Auxx-Ai/auxx-ai/issues/1656)) ([aaa3ac8](https://github.com/Auxx-Ai/auxx-ai/commit/aaa3ac8b809c08b1310f8ea950addaae84accd9f))
* **fields:** give multi-value phone fields a country selector and e.164 entry ([#1658](https://github.com/Auxx-Ai/auxx-ai/issues/1658)) ([640199a](https://github.com/Auxx-Ai/auxx-ai/commit/640199af86bad111342eee73ff75f19acae162a5))
* **import:** append-as-alias for multi-value fields with row-warning channel ([#1620](https://github.com/Auxx-Ai/auxx-ai/issues/1620)) ([285cc3a](https://github.com/Auxx-Ai/auxx-ai/commit/285cc3a606c804c0d592d4429037cafa6ae02649))
* **kbar:** weight palette scoring and flatten search results ([#1696](https://github.com/Auxx-Ai/auxx-ai/issues/1696)) ([7ffee33](https://github.com/Auxx-Ai/auxx-ai/commit/7ffee33560ebbe3f0d7bf745d209ad8332f84dcc))
* **kopilot:** add safe deep node config patches ([#1630](https://github.com/Auxx-Ai/auxx-ai/issues/1630)) ([9bd0c53](https://github.com/Auxx-Ai/auxx-ai/commit/9bd0c531d6d52eece4cc9f6570d12b0d61ec94a1))
* **kopilot:** add workflow detail editing ([#1626](https://github.com/Auxx-Ai/auxx-ai/issues/1626)) ([3cd0af8](https://github.com/Auxx-Ai/auxx-ai/commit/3cd0af8425abfc1f85a933f89744b0b617ea8f9f))
* **kopilot:** improve workflow builder discovery ([#1631](https://github.com/Auxx-Ai/auxx-ai/issues/1631)) ([aa4dc9b](https://github.com/Auxx-Ai/auxx-ai/commit/aa4dc9b5e5f068f27b18810f374133e522957a55))
* **kopilot:** wire workflow builder capability with canvas-history undo ([#1608](https://github.com/Auxx-Ai/auxx-ai/issues/1608)) ([2721542](https://github.com/Auxx-Ai/auxx-ai/commit/27215426480cf408e72830d449803c9e07fb5759))
* **kopilot:** workflow-builder capability — graph tools, authoring guard, per-turn undo ([#1607](https://github.com/Auxx-Ai/auxx-ai/issues/1607)) ([86bf493](https://github.com/Auxx-Ai/auxx-ai/commit/86bf4931bd6b89506774e276482f985218b1bd17))
* **mail-filters:** channel-aware mail filters ([#1660](https://github.com/Auxx-Ai/auxx-ai/issues/1660)) ([2fe91a6](https://github.com/Auxx-Ai/auxx-ai/commit/2fe91a62295c4c1c68a8edcfc173a79c9bfac880))
* **messages:** one message-type vocabulary and a stored per-message column ([#1683](https://github.com/Auxx-Ai/auxx-ai/issues/1683)) ([39b0496](https://github.com/Auxx-Ai/auxx-ai/commit/39b049696f8e2f75e8b473cef01e759fa39ae60d))
* **messages:** quo call/voicemail ingest and a messageType filter ([#1685](https://github.com/Auxx-Ai/auxx-ai/issues/1685)) ([7c981e1](https://github.com/Auxx-Ai/auxx-ai/commit/7c981e13ba185fb00219aa7e34751bb0a6c91df2))
* **participants:** contact-name precedence for mail labels ([#1691](https://github.com/Auxx-Ai/auxx-ai/issues/1691)) ([e165aad](https://github.com/Auxx-Ai/auxx-ai/commit/e165aad5c98dc917606058960ab47658d034e8a8))
* **participants:** publish participant:updated from composer and chat identity writes ([#1694](https://github.com/Auxx-Ai/auxx-ai/issues/1694)) ([4f589a7](https://github.com/Auxx-Ai/auxx-ai/commit/4f589a7f545dee55109e6f66a7a6385c964bed15))
* **participants:** ranked recipient search SQL builders ([#1668](https://github.com/Auxx-Ai/auxx-ai/issues/1668)) ([54760ec](https://github.com/Auxx-Ai/auxx-ai/commit/54760ec7cb7b31876030341cf80ac03816f6ab1c))
* **participants:** searchRecipients read and the search.recipients procedure ([#1670](https://github.com/Auxx-Ai/auxx-ai/issues/1670)) ([fd34835](https://github.com/Auxx-Ai/auxx-ai/commit/fd348354905e1ba184db8e884b9dcceaa7cfd0bf))
* **rate-limiter:** shared redis-backed pacer for channels and connectors ([#1651](https://github.com/Auxx-Ai/auxx-ai/issues/1651)) ([b124f13](https://github.com/Auxx-Ai/auxx-ai/commit/b124f1380e647b7d7905316410b5a786f35a933f))
* **records:** array-aware email uniqueness, value cap, lookup-core extraction ([#1618](https://github.com/Auxx-Ai/auxx-ai/issues/1618)) ([d059473](https://github.com/Auxx-Ai/auxx-ai/commit/d0594732d86023e1cb3b46de1129b96188721e65))
* **records:** contact/company first/last interaction fields ([#1590](https://github.com/Auxx-Ai/auxx-ai/issues/1590)) ([f954a1f](https://github.com/Auxx-Ai/auxx-ai/commit/f954a1f7a980b3884b73685f7b38dee8b6f44974))
* **records:** duplicate suggestion surfaces, router and merge wire-up ([#1643](https://github.com/Auxx-Ai/auxx-ai/issues/1643)) ([fa54144](https://github.com/Auxx-Ai/auxx-ai/commit/fa541443c171fe6c3edd2bb67b75ff7079e8ee2f))
* **records:** duplicate-suggestion schema, flag and matching engine ([#1640](https://github.com/Auxx-Ai/auxx-ai/issues/1640)) ([b8f06b4](https://github.com/Auxx-Ai/auxx-ai/commit/b8f06b4e0539ea223db654aa33e28c84fc261e48))
* **records:** flip contact email and company website to multi-value (C4/C5) ([#1625](https://github.com/Auxx-Ai/auxx-ai/issues/1625)) ([a76a72e](https://github.com/Auxx-Ai/auxx-ai/commit/a76a72ead5f0f407d29067e7db615776d34ed052))
* **records:** flip contact phone to multi-value ([#1634](https://github.com/Auxx-Ai/auxx-ai/issues/1634)) ([56a863e](https://github.com/Auxx-Ai/auxx-ai/commit/56a863e1af99d809c50c9ecf3c872f3458264cd8))
* **records:** merge-dialog grant warning and multi-value union cap ([#1624](https://github.com/Auxx-Ai/auxx-ai/issues/1624)) ([12c9798](https://github.com/Auxx-Ai/auxx-ai/commit/12c979874a0ee03bcdd79017f385eefadf5ead25))
* **records:** multi-safe writer sweep for email/phone/website ([#1619](https://github.com/Auxx-Ai/auxx-ai/issues/1619)) ([21423a0](https://github.com/Auxx-Ai/auxx-ai/commit/21423a043ea776d74dee4447b5c666acc4692740))
* **records:** multi-value contracts — primaryValue helper, cap constant, structured conflict error ([#1614](https://github.com/Auxx-Ai/auxx-ai/issues/1614)) ([c4aef02](https://github.com/Auxx-Ai/auxx-ai/commit/c4aef02fd557088b01f2d8c4a2cdc03528500196))
* **records:** multi-value setPrimary, read rendering and value-list picker ([#1623](https://github.com/Auxx-Ai/auxx-ai/issues/1623)) ([d7967ff](https://github.com/Auxx-Ai/auxx-ai/commit/d7967ff015241f617512aa53dd893a003904b2f3))
* **search:** index participant identifiers and field values for recipient search ([#1665](https://github.com/Auxx-Ai/auxx-ai/issues/1665)) ([8e20814](https://github.com/Auxx-Ai/auxx-ai/commit/8e20814d6a8c588bd817653589db60aebfada336))
* **threads:** collapsible day separators and group-row hover polish ([#1693](https://github.com/Auxx-Ai/auxx-ai/issues/1693)) ([26ef44a](https://github.com/Auxx-Ai/auxx-ai/commit/26ef44afbcb492a54e05b7d554335a7090a86f5d))
* **threads:** inline thread event timeline backed by a dedicated ThreadEvent table ([#1686](https://github.com/Auxx-Ai/auxx-ai/issues/1686)) ([d10bb4a](https://github.com/Auxx-Ai/auxx-ai/commit/d10bb4a21f617a07a9c6b20a6aaa33239da6cef7))
* **threads:** inline timeline v2 with day separators, event blocks and net-effect summaries ([#1692](https://github.com/Auxx-Ai/auxx-ai/issues/1692)) ([8b139c3](https://github.com/Auxx-Ai/auxx-ai/commit/8b139c32c0b33b34994e2909622657932d791768))
* **workflow:** absorb server trigger branches into shared catalog derivation ([#1601](https://github.com/Auxx-Ai/auxx-ai/issues/1601)) ([b3af007](https://github.com/Auxx-Ai/auxx-ai/commit/b3af007d7104885bc48cfcfef731248c357aab37))
* **workflow:** dedicated kopilot builder panel with its own session ([#1622](https://github.com/Auxx-Ai/auxx-ai/issues/1622)) ([3c74a27](https://github.com/Auxx-Ai/auxx-ai/commit/3c74a27145a5e28824ac2cafe367f753264ed466))
* **workflow:** graph-edit operations, validation pipeline and draft persistence ([#1604](https://github.com/Auxx-Ai/auxx-ai/issues/1604)) ([d03ac32](https://github.com/Auxx-Ai/auxx-ai/commit/d03ac32073a8d6f07f4716be574dc9bac801db10))
* **workflow:** graph-edit refs and friendly normalization layer ([#1603](https://github.com/Auxx-Ai/auxx-ai/issues/1603)) ([daa13ac](https://github.com/Auxx-Ai/auxx-ai/commit/daa13ac289b4e17391de58d0f08a38d072172a06))
* **workflow:** graph-edit turn snapshot, realtime signal, cas surfacing, run node ([#1606](https://github.com/Auxx-Ai/auxx-ai/issues/1606)) ([1fc65e9](https://github.com/Auxx-Ai/auxx-ai/commit/1fc65e9e2016e9f713baf96b1df72cb46a7e31f7))
* **workflow:** let knowledge retrieval search knowledge bases ([#1642](https://github.com/Auxx-Ai/auxx-ai/issues/1642)) ([f591e0f](https://github.com/Auxx-Ai/auxx-ai/commit/f591e0ff16bfce0856e1880623aa9efc4a3ebd1d))
* **workflow:** let message triggers decide on own-address mail ([#1581](https://github.com/Auxx-Ai/auxx-ai/issues/1581)) ([46e7c32](https://github.com/Auxx-Ai/auxx-ai/commit/46e7c32a06ead089b8f3041cf32583004f21c163))
* **workflow:** lock the canvas while a kopilot turn holds the draft ([#1636](https://github.com/Auxx-Ai/auxx-ai/issues/1636)) ([b6963d5](https://github.com/Auxx-Ai/auxx-ai/commit/b6963d5611beba23b4117e37bb63f35745ef959a))
* **workflow:** migrate crud/find nodes to catalog with engine fixes ([#1584](https://github.com/Auxx-Ai/auxx-ai/issues/1584)) ([bbca5fb](https://github.com/Auxx-Ai/auxx-ai/commit/bbca5fb834efe136e757033389ff7f08feb04c2d))
* **workflow:** migrate form-input to the node catalog and fix input-wiring validation ([#1649](https://github.com/Auxx-Ai/auxx-ai/issues/1649)) ([979674a](https://github.com/Auxx-Ai/auxx-ai/commit/979674a3ef20489e9751453f34c425536cc8b323))
* **workflow:** migrate knowledge retrieval to the node catalog ([#1644](https://github.com/Auxx-Ai/auxx-ai/issues/1644)) ([852a806](https://github.com/Auxx-Ai/auxx-ai/commit/852a8067e4a080715acd6c91320d989e7a375604))
* **workflow:** migrate the dataset node family to the catalog ([#1645](https://github.com/Auxx-Ai/auxx-ai/issues/1645)) ([5112194](https://github.com/Auxx-Ai/auxx-ai/commit/51121948e74276a66e6cda743d05d1f2df15a9b4))
* **workflow:** move dagre layout helpers into lib graph-edit ([#1602](https://github.com/Auxx-Ai/auxx-ai/issues/1602)) ([21e4bf7](https://github.com/Auxx-Ai/auxx-ai/commit/21e4bf76e5d409ee02b8f47508bfb125e723503a))
* **workflow:** one-call form-input authoring via add_node inputFor ([#1650](https://github.com/Auxx-Ai/auxx-ai/issues/1650)) ([7b48b38](https://github.com/Auxx-Ai/auxx-ai/commit/7b48b38bfc170747f0d21da1985ce9444d78c22a))
* **workflow:** per-field update modes for multi-value scalar fields in crud/find nodes ([#1617](https://github.com/Auxx-Ai/auxx-ai/issues/1617)) ([9049cbe](https://github.com/Auxx-Ai/auxx-ai/commit/9049cbe1b62797c0e90d42176c2055a554132c1a))
* **workflow:** replace side-by-side panel docking with a nav stack ([#1610](https://github.com/Auxx-Ai/auxx-ai/issues/1610)) ([d46389e](https://github.com/Auxx-Ai/auxx-ai/commit/d46389eb2a7fa46fc4d9cec6a49f0742a9620698))
* **workflow:** resolve node outputs server-side with browser parity ([#1579](https://github.com/Auxx-Ai/auxx-ai/issues/1579)) ([559c0ad](https://github.com/Auxx-Ai/auxx-ai/commit/559c0ad3b2b6d5bf55c162629e94bf54a7554f76))
* **workflow:** variable chip editing with explorer and array access menu ([#1605](https://github.com/Auxx-Ai/auxx-ai/issues/1605)) ([3557ace](https://github.com/Auxx-Ai/auxx-ai/commit/3557acebb39d2161d91920b8320b811d0b1e2011))


### Bug Fixes

* **billing:** hide custom-pricing plans on shopify-billed orgs ([#1633](https://github.com/Auxx-Ai/auxx-ai/issues/1633)) ([c7f4c70](https://github.com/Auxx-Ai/auxx-ai/commit/c7f4c70970397b9e373287144a351aa62db5b11e))
* **channels:** arm and tear down facebook/instagram webhooks for real ([#1699](https://github.com/Auxx-Ai/auxx-ai/issues/1699)) ([ff7a427](https://github.com/Auxx-Ai/auxx-ai/commit/ff7a4273b2cfe739974ed566d823f1f6a45df175))
* **channels:** derive one thread key for facebook/instagram DMs ([#1697](https://github.com/Auxx-Ai/auxx-ai/issues/1697)) ([3284754](https://github.com/Auxx-Ai/auxx-ai/commit/3284754f708614b1eecde12cdbc2b74b6bf0b758))
* **channels:** gmail backfill trigger cutoff + enqueue-based webhook route ([#1589](https://github.com/Auxx-Ai/auxx-ai/issues/1589)) ([8efddbc](https://github.com/Auxx-Ai/auxx-ai/commit/8efddbcf5472ace145465c46ef760d3d47a023e6))
* **channels:** invalidate channels cache when credential auth state changes ([#1681](https://github.com/Auxx-Ai/auxx-ai/issues/1681)) ([7969989](https://github.com/Auxx-Ai/auxx-ai/commit/7969989996889131d30b178632d9bae66c1d764b))
* **channels:** let the polling scanner drive webhook-mode backfills to completion ([#1587](https://github.com/Auxx-Ai/auxx-ai/issues/1587)) ([5fed80d](https://github.com/Auxx-Ai/auxx-ai/commit/5fed80d306052c1657fda8e695538954b1e2bac6))
* **channels:** point fb/ig oauth defs at the live meta app ([#1687](https://github.com/Auxx-Ai/auxx-ai/issues/1687)) ([c62dac7](https://github.com/Auxx-Ai/auxx-ai/commit/c62dac7ceb86ca81b28a74ddc2fe3af8ad2c78a8))
* **channels:** route channel webhook callbacks through ngrok in dev ([#1586](https://github.com/Auxx-Ai/auxx-ai/issues/1586)) ([7423243](https://github.com/Auxx-Ai/auxx-ai/commit/7423243c4848ef1fd4f9bdcb8df9ed6f21d15a4e))
* **channels:** self-heal stale channels cache on live-state refusals ([#1684](https://github.com/Auxx-Ai/auxx-ai/issues/1684)) ([d496e48](https://github.com/Auxx-Ai/auxx-ai/commit/d496e480ae7fa90af4f7c02911d4cabd79131fea))
* **channels:** thread, render and deliver quo sms correctly ([#1662](https://github.com/Auxx-Ai/auxx-ai/issues/1662)) ([3303bd8](https://github.com/Auxx-Ai/auxx-ai/commit/3303bd8225709005a5c9e8a2cf97c65eca59ade3))
* **chat:** block boot attributes from overwriting contact identity fields ([#1611](https://github.com/Auxx-Ai/auxx-ai/issues/1611)) ([e706eee](https://github.com/Auxx-Ai/auxx-ai/commit/e706eeeb0100f2d598b13e76dcbea2785691117f))
* **chat:** keep the chat composer mounted when a chat thread pops out ([#1677](https://github.com/Auxx-Ai/auxx-ai/issues/1677)) ([532db8b](https://github.com/Auxx-Ai/auxx-ai/commit/532db8b121dbbba499f582bcbafb2b7d7bd72176))
* **composer:** keep the composer mounted across every display-mode swap ([#1676](https://github.com/Auxx-Ai/auxx-ai/issues/1676)) ([f0fc2a7](https://github.com/Auxx-Ai/auxx-ai/commit/f0fc2a7b16971413618d0d7b69ea3544d1c72f5f))
* **composer:** mint recipient chip ids and remount the input on a model switch ([#1664](https://github.com/Auxx-Ai/auxx-ai/issues/1664)) ([a477642](https://github.com/Auxx-Ai/auxx-ai/commit/a477642c2b3d3d916cdbcd6f833b5f76d6c68c75))
* **connectors:** drop format-rejected values instead of failing the record ([#1632](https://github.com/Auxx-Ai/auxx-ai/issues/1632)) ([42de622](https://github.com/Auxx-Ai/auxx-ai/commit/42de622596321d11ce5e88c1f342bebb9e69f0ec))
* **connectors:** make the quo contacts connector set up and map correctly ([#1679](https://github.com/Auxx-Ai/auxx-ai/issues/1679)) ([c5f5456](https://github.com/Auxx-Ai/auxx-ai/commit/c5f5456a3a3124309cac01479bed0f86ade3be6e))
* **credentials:** lazy token refresh for billing ([#1583](https://github.com/Auxx-Ai/auxx-ai/issues/1583)) ([f41f236](https://github.com/Auxx-Ai/auxx-ai/commit/f41f2365301b2f5085c5484196e81288ddb4e5a9))
* **field-values:** make boolean and date schemas actually reject ([#1635](https://github.com/Auxx-Ai/auxx-ai/issues/1635)) ([fd7215d](https://github.com/Auxx-Ai/auxx-ai/commit/fd7215d3cfa5f7e1a3f2d26b365ccb37baea1715))
* **fields:** persist set-as-primary on multi-value fields ([#1637](https://github.com/Auxx-Ai/auxx-ai/issues/1637)) ([ba66bab](https://github.com/Auxx-Ai/auxx-ai/commit/ba66bab20986f1441e06dc5bcdce4f3acf253f44))
* **kopilot:** normalize agent phone recipients through libphonenumber, not a separator strip ([#1667](https://github.com/Auxx-Ai/auxx-ai/issues/1667)) ([009bc60](https://github.com/Auxx-Ai/auxx-ai/commit/009bc6090fcc6b0fe3f50e8f74da02b99c64be4c))
* **messages:** render sms as chat bubbles and stamp the right message type ([#1663](https://github.com/Auxx-Ai/auxx-ai/issues/1663)) ([b3a8279](https://github.com/Auxx-Ai/auxx-ai/commit/b3a8279c60edfa39547bcb6cc22dd64a42a188c7))
* **messages:** stop the sent-echo reconciler from swallowing inbound SMS ([#1653](https://github.com/Auxx-Ai/auxx-ai/issues/1653)) ([3b47656](https://github.com/Auxx-Ai/auxx-ai/commit/3b476565ec9d82c335a077de24ee3139038a78bf))
* **messages:** write the thread participant rollup on outbound sends ([#1659](https://github.com/Auxx-Ai/auxx-ai/issues/1659)) ([baa55d7](https://github.com/Auxx-Ai/auxx-ai/commit/baa55d7d7d558741265414d07b44c3591d98a47a))
* **participants:** composer upsert never downgrades a known name ([#1695](https://github.com/Auxx-Ai/auxx-ai/issues/1695)) ([f2c6e89](https://github.com/Auxx-Ai/auxx-ai/commit/f2c6e89f2d2a9cfcee6ef62c5b827c98ab35e1ad))
* **participants:** resolve channel identity on every channel, not just email ([#1655](https://github.com/Auxx-Ai/auxx-ai/issues/1655)) ([d9f0d53](https://github.com/Auxx-Ai/auxx-ai/commit/d9f0d5315d01f88d96a9e84f02504d0b2f1d4217))
* **permissions:** scope kb and dataset list reads so their pickers work ([#1661](https://github.com/Auxx-Ai/auxx-ai/issues/1661)) ([a3c01ad](https://github.com/Auxx-Ai/auxx-ai/commit/a3c01adf4f6bc82c5fc60584efc2fbc50bfacc51))
* **records:** close org-wide email uniqueness bypass on fieldValue service doors ([#1628](https://github.com/Auxx-Ai/auxx-ai/issues/1628)) ([3de8514](https://github.com/Auxx-Ai/auxx-ai/commit/3de8514e5572d565827560f916619c4566776a0d))
* **records:** deterministic primary-value reads via sortkey ordering ([#1613](https://github.com/Auxx-Ai/auxx-ai/issues/1613)) ([548fdc6](https://github.com/Auxx-Ai/auxx-ai/commit/548fdc68305454764b0d83a8f0863fabe442e9c0))
* **records:** export current view csv matches the rendered table ([#1597](https://github.com/Auxx-Ai/auxx-ai/issues/1597)) ([049b094](https://github.com/Auxx-Ai/auxx-ai/commit/049b094c3c28d7ebcdc2e894a4a7a8e37df7a486))
* **records:** hide interaction columns in tables by default ([#1592](https://github.com/Auxx-Ai/auxx-ai/issues/1592)) ([4a67394](https://github.com/Auxx-Ai/auxx-ai/commit/4a673943edfbbffaf4d3a2e5b5dcb1a64b25865d))
* **records:** keep multi-value email/url table cells array-shaped ([#1627](https://github.com/Auxx-Ai/auxx-ai/issues/1627)) ([8226181](https://github.com/Auxx-Ai/auxx-ai/commit/8226181f69207e2cf8b22b3d975c8b4cd4380a1c))
* **records:** multi-value-safe display recalc and extension lookup parse ([#1616](https://github.com/Auxx-Ai/auxx-ai/issues/1616)) ([7d42720](https://github.com/Auxx-Ai/auxx-ai/commit/7d427207ed2fc2104ab18664523cef9a48fcc717))
* **records:** normalize phone numbers to E.164 via libphonenumber-js ([#1629](https://github.com/Auxx-Ai/auxx-ai/issues/1629)) ([1fc462b](https://github.com/Auxx-Ai/auxx-ai/commit/1fc462b03e93895aabe1145e1e2687f959695497))
* **records:** re-point participants, threads and connector items on merge ([#1615](https://github.com/Auxx-Ai/auxx-ai/issues/1615)) ([4254b0e](https://github.com/Auxx-Ai/auxx-ai/commit/4254b0ebd5f76c0a63ddc1f7c0ec84a0173f61e4))
* **records:** run the duplicate name-matching arm and fix queue surfaces ([#1647](https://github.com/Auxx-Ai/auxx-ai/issues/1647)) ([34cc41d](https://github.com/Auxx-Ai/auxx-ai/commit/34cc41dd75c9205c8e936beab984fe3d2920b313))
* **records:** stamp interactions on participant-linked contacts ([#1591](https://github.com/Auxx-Ai/auxx-ai/issues/1591)) ([4b47c52](https://github.com/Auxx-Ai/auxx-ai/commit/4b47c5214d8c51ac2303e12156897f4dc28735a6))
* **records:** write both interaction stamps in one update in migration 082 ([#1594](https://github.com/Auxx-Ai/auxx-ai/issues/1594)) ([649340e](https://github.com/Auxx-Ai/auxx-ai/commit/649340e9d40c4d4dd92ad358476e84d55be55677))
* **search:** stop the recipients procedure breaking router test collection ([#1674](https://github.com/Auxx-Ai/auxx-ai/issues/1674)) ([13951e4](https://github.com/Auxx-Ai/auxx-ai/commit/13951e4f7bbaae230f6abd0ea1c1b44919a93166))
* **sync:** isolate record failures from the run, and stop fast on systemic ones ([#1680](https://github.com/Auxx-Ai/auxx-ai/issues/1680)) ([09bc05d](https://github.com/Auxx-Ai/auxx-ai/commit/09bc05d2b8c8b3b0cbd86de1f0c6049e168b1b8f))
* **tests:** stamp messageType in the lens/search int-test inserts ([#1690](https://github.com/Auxx-Ai/auxx-ai/issues/1690)) ([cd5adc0](https://github.com/Auxx-Ai/auxx-ai/commit/cd5adc0c0064f7d14f7b84e83f968030bf6af045))
* **web:** clear the apps/web typecheck baseline ([#1612](https://github.com/Auxx-Ai/auxx-ai/issues/1612)) ([e8077d3](https://github.com/Auxx-Ai/auxx-ai/commit/e8077d3662051fccddcc62ebe8dc5c47b4b54144))
* **workflow:** drop server-only catalog exports from client barrel ([#1582](https://github.com/Auxx-Ai/auxx-ai/issues/1582)) ([c3ed9b8](https://github.com/Auxx-Ai/auxx-ai/commit/c3ed9b8384f9a96d1d19d570fdbc773fe3e2146b))
* **workflow:** guard scheduled resolver and isolate resolver crashes ([#1609](https://github.com/Auxx-Ai/auxx-ai/issues/1609)) ([78ee8c4](https://github.com/Auxx-Ai/auxx-ai/commit/78ee8c4fdaf0b2197ec5b2eb41a0dc993bd959b2))
* **workflow:** key findMany output on resource id, not plural label ([#1599](https://github.com/Auxx-Ai/auxx-ai/issues/1599)) ([909f7d1](https://github.com/Auxx-Ai/auxx-ai/commit/909f7d19ded7243b23aceae40707a58cbcdc3b9d))
* **workflow:** paste ref rewriting, output-var labels, declared-var gaps ([#1600](https://github.com/Auxx-Ai/auxx-ai/issues/1600)) ([849caa4](https://github.com/Auxx-Ai/auxx-ai/commit/849caa412b34578a796fad3f29f18ce7134fad14))
* **workflow:** resolve tier-a find fields under their declared keys ([#1598](https://github.com/Auxx-Ai/auxx-ai/issues/1598)) ([9f3464a](https://github.com/Auxx-Ai/auxx-ai/commit/9f3464a4ee3600b54349d8a19a0c9d8e645b12b6))
