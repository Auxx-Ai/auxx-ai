...
var example_webhook_exports = {}
__export(example_webhook_exports, {
  default: () => leadProcessedWebhook,
})
async function leadProcessedWebhook(req) {
...
var connection_removed_event_exports = {}
__export(connection_removed_event_exports, {
  default: () => connectionRemoved,
})
async function connectionRemoved({ connection }) {
  const webhookHandlers = await (0, import_server2.listWebhookHandlers)()
  for (const webhookHandler of webhookHandlers) {
    ...
    await (0, import_server2.deleteWebhookHandler)(webhookHandler.id)
  }
}
var import_server2
...
var connection_added_event_exports = {}
__export(connection_added_event_exports, {
  default: () => connectionAdded,
})
async function connectionAdded({ connection }) {
  const webhookHandler = await (0, import_server3.createWebhookHandler)({
    fileName: 'example',
  })
  ...
  await (0, import_server3.updateWebhookHandler)(webhookHandler.id, {
...
// ../../../var/folders/m1/4mnt5gm55lbgxc1s3p35rm480000gn/T/tmp-70999-x7JxRkD0eujo-.js
...
modules.set('get-user.server', () =>
  Promise.resolve().then(() => (init_get_user_server(), get_user_server_exports))
)
webhookModules.set('example', () =>
  Promise.resolve().then(() => (init_example_webhook(), example_webhook_exports))
)
eventModules.set('connection-removed', () =>
  Promise.resolve().then(() => (init_connection_removed_event(), connection_removed_event_exports))
)
eventModules.set('connection-added', () =>
  Promise.resolve().then(() => (init_connection_added_event(), connection_added_event_exports))
)
var stdin_default
