...
export const WorkflowCredentials = pgTable(
  'WorkflowCredentials',
  {
    ...
    userId: text().references((): AnyPgColumn => User.id, { onUpdate: 'cascade', onDelete: 'cascade' }),
    appId: text().references((): AnyPgColumn => App.id, { onUpdate: 'cascade', onDelete: 'cascade' }),
