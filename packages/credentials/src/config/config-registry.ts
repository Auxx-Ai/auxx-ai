...
export const CONFIG_VARIABLES = {
  ...
  PUSHER_CLUSTER: {
    key: 'PUSHER_CLUSTER',
    description:
      'Pusher cluster region (only used when PUSHER_HOST is empty → hosted Pusher cloud)',
    type: ConfigVariableType.STRING,
    group: ConfigVariableGroup.REALTIME,
    defaultValue: 'us3',
    isSensitive: false,
  ...
  PUSHER_HOST: {
    key: 'PUSHER_HOST',
    description:
      'Self-hosted Sockudo host (e.g. echtzeit.<env>.auxx.ai). Empty → falls back to the hosted Pusher cloud.',
    type: ConfigVariableType.STRING,
    group: ConfigVariableGroup.REALTIME,
    isSensitive: false,
    isEnvOnly: false,
  ...
  PUSHER_PORT: {
    key: 'PUSHER_PORT',
    description: 'Sockudo port (443 behind Railway TLS edge; 6001 for local plain ws)',
    type: ConfigVariableType.NUMBER,
    group: ConfigVariableGroup.REALTIME,
    defaultValue: 443,
    isSensitive: false,
  ...
  PUSHER_USE_TLS: {
    key: 'PUSHER_USE_TLS',
    description: 'Use TLS/wss for the Sockudo connection (true in prod, false for local plain ws)',
    type: ConfigVariableType.BOOLEAN,
    group: ConfigVariableGroup.REALTIME,
    defaultValue: true,
    isSensitive: false,
