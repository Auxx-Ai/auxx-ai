// packages/lib/src/email/labels/guard.ts
 ...
 *
 * Duplicated from `snippets/guard.ts` on purpose (module guide §3): 31 lines is
 * cheaper than a shared abstraction, and it lets this module bind its own
 * logger scope so label failures are greppable as `scope='labels'`.
 */
