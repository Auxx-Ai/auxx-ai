// packages/lib/src/relief/guard.ts
 ...
 * `stock-movements/guard.ts` - small enough that duplicating it beats a
 * shared abstraction, and duplicating it is what lets this module bind its
