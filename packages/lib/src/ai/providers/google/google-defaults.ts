...
export const GOOGLE_MODELS: Record<string, ModelCapabilities> = {
  ...
  'gemini-3.1-pro-preview': {
    ...
    costPer1kTokens: {
      ...
      output: 0.012,
      cachedInput: 0.0002,
      longContext: [{ over: 200000, input: 0.004, output: 0.018, cachedInput: 0.0004 }],
    },
  ...
  'gemini-3-flash-preview': {
    ...
    features: ['chat', 'multimodal', 'tools', 'thinking'],
    supports: fullLlmSupports,
    costPer1kTokens: { input: 0.0005, output: 0.003, cachedInput: 0.00005 },
  ...
  'gemini-3.1-flash-lite-preview': {
    ...
    features: ['chat', 'multimodal', 'tools', 'thinking'],
    supports: fullLlmSupports,
    costPer1kTokens: { input: 0.00025, output: 0.0015, cachedInput: 0.000025 },
  ...
  'gemini-2.5-pro': {
    ...
    costPer1kTokens: {
      ...
      longContext: [{ over: 200000, input: 0.0025, output: 0.015, cachedInput: 0.00025 }],
    },
  ...
  'gemini-2.5-flash': {
    ...
    features: ['chat', 'multimodal', 'tools', 'thinking'],
    supports: fullLlmSupports,
    costPer1kTokens: { input: 0.0003, output: 0.0025, cachedInput: 0.00003 },
  ...
  'gemini-2.5-flash-lite': {
    ...
    features: ['chat', 'multimodal', 'tools', 'thinking'],
    supports: fullLlmSupports,
    costPer1kTokens: { input: 0.0001, output: 0.0004, cachedInput: 0.00001 },
