...
// ---------------------------------------------------------------------------
// Shared parameter rule arrays — reused across models to reduce duplication
// ---------------------------------------------------------------------------

/** Reasoning effort for GPT-5.2+ models (low–xhigh; 'none' is NOT supported by these models) */
const GPT5_REASONING_EFFORT: ParameterRule = {
...
/** Reasoning effort for pro models (medium/high/xhigh only) */
const REASONING_EFFORT_PRO: ParameterRule = {
  name: 'reasoning_effort',
  type: 'string',
  label: 'Reasoning Effort',
  help: 'Controls how much reasoning the model performs',
...
/** O-series reasoning effort (low/medium/high) */
const O_SERIES_REASONING_EFFORT: ParameterRule = {
  name: 'reasoning_effort',
  type: 'string',
  label: 'Reasoning Effort',
  help: 'Controls how much reasoning the model performs',
...
const CONDITIONAL_TEMPERATURE: ParameterRule = {
  name: 'temperature',
  type: 'float',
  label: 'Temperature',
...
const CONDITIONAL_TOP_P: ParameterRule = {
  name: 'top_p',
  type: 'float',
  label: 'Top P',
...
const CONDITIONAL_LOGPROBS: ParameterRule = {
  name: 'logprobs',
  type: 'boolean',
  label: 'Logprobs',
  help: 'Whether to return token log probabilities for compatible effort modes.',
  default: false,
  required: false,
  template: 'logprobs',
}

const CONDITIONAL_TOP_LOGPROBS: ParameterRule = {
  name: 'top_logprobs',
  type: 'int',
  label: 'Top Logprobs',
...
const VERBOSITY_RULE: ParameterRule = {
  name: 'verbosity',
  type: 'string',
  label: 'Verbosity',
...
function gpt5Params(maxTokens: number, defaultTokens = 8192): ParameterRule[] {
  return [
    ...
    CONDITIONAL_TOP_LOGPROBS,
    maxCompletionTokensRule(maxTokens, defaultTokens),
  ]
}
...
/** Parameter restrictions for GPT-5.2+ conditional models */
const GPT5_CONDITIONAL_RESTRICTIONS: ModelCapabilities['parameterRestrictions'] = {
  unsupportedParams: ['presence_penalty', 'frequency_penalty', 'logit_bias'],
  defaultOnlyParams: {},
  parameterMapping: { max_tokens: 'max_completion_tokens' },
  isReasoningModel: true,
}

/** Parameter restrictions for o-series reasoning models */
const O_SERIES_RESTRICTIONS: ModelCapabilities['parameterRestrictions'] = {
  unsupportedParams: [
    'presence_penalty',
    'frequency_penalty',
    'logprobs',
...
/** Parameter restrictions for pro reasoning models (no sampling at all) */
const PRO_REASONING_RESTRICTIONS: ModelCapabilities['parameterRestrictions'] = {
  unsupportedParams: [
    'presence_penalty',
    'frequency_penalty',
    'logprobs',
...
export const OPENAI_MODELS: Record<string, ModelCapabilities> = {
  ...
  'gpt-5.5-pro': {
    ...
    costPer1kTokens: { input: 0.03, output: 0.18 },
    description: 'GPT-5.5 Pro — highest capability, always-on reasoning (medium/high/xhigh)',
    parameterRules: [REASONING_EFFORT_PRO, VERBOSITY_RULE, maxCompletionTokensRule(128000)],
    parameterRestrictions: PRO_REASONING_RESTRICTIONS,
  },
  'gpt-5.3-chat-latest': {
  ...
  'gpt-5.3-codex': {
    ...
    costPer1kTokens: { input: 0.00175, output: 0.014 },
    description: 'GPT-5.3 Codex — code-focused model, always-on reasoning (no none)',
    parameterRules: [GPT5_REASONING_EFFORT, VERBOSITY_RULE, maxCompletionTokensRule(128000)],
    parameterRestrictions: PRO_REASONING_RESTRICTIONS,
  },
  'gpt-5.1': {
    provider: 'openai',
  ...
  'o3-pro': {
    ...
    parameterRules: oSeriesParams(100000, 16384),
    parameterRestrictions: O_SERIES_RESTRICTIONS,
  },
  'o3-pro-2025-06-10': {
    provider: 'openai',
  ...
  'omni-moderation-latest': {
    ...
    description: 'Multimodal content moderation with text and image support',
    parameterRules: [],
  },
