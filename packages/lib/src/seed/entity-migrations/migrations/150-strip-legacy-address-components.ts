// packages/lib/src/seed/entity-migrations/migrations/150-strip-legacy-address-components.ts
 ...
 */
export const migration150StripLegacyAddressComponents: EntityMigration = {
  ...
  async up(db: Database, organizationId: string): Promise<EntityMigrationResult> {
    ...
    // `runEntityMigrationsForOrg` flushes after the whole batch, but `up()` is
