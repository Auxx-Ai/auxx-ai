...
import { CUSTOMER_TRANSACTION_FIELDS } from './resources/customer-transaction-fields'
...
import { PROCESSOR_BALANCE_ENTRY_FIELDS } from './resources/processor-balance-entry-fields'
