...
export const CREDIT_MEMO_APPLICATION_FIELDS = defineResourceFields({
  ...
  operation: {
    ...
    fieldType: FieldType.TEXT,
    isSystem: true,
    systemAttribute: 'credit_memo_application_operation',
    systemSortOrder: 'a5',
    nullable: true,
    capabilities: {
      filterable: true,
  ...
  reversesApplication: {
    id: toFieldId('reversesApplication'),
    key: 'reversesApplication',
    label: 'Reverses application',
    type: BaseType.RELATION,
    fieldType: FieldType.RELATIONSHIP,
    isSystem: true,
    systemAttribute: 'credit_memo_application_reverses',
    systemSortOrder: 'a6',
    nullable: true,
    capabilities: {
      filterable: true,
    ...
    relationship: {
      inverseResourceFieldId: 'credit_memo_application:reversals' as ResourceFieldId,
      relationshipType: 'belongs_to',
      isInverse: false,
    },
    relationshipConfig: {
      relatedEntityType: 'credit_memo_application',
      inverseName: 'Reversals',
      inverseSystemAttribute: 'credit_memo_application_reversals',
      relationshipType: 'belongs_to',
    },
    description: 'The original application restored by this reversal.',
  },

  reversals: {
    id: toFieldId('reversals'),
    key: 'reversals',
    label: 'Reversals',
    type: BaseType.RELATION,
    fieldType: FieldType.RELATIONSHIP,
    isSystem: true,
    systemAttribute: 'credit_memo_application_reversals',
    systemSortOrder: 'a7',
    nullable: true,
    capabilities: {
      filterable: false,
    ...
    relationship: {
      inverseResourceFieldId: 'credit_memo_application:reversesApplication' as ResourceFieldId,
      relationshipType: 'has_many',
      isInverse: true,
      onDelete: 'restrict',
    },
    description: 'Records that restore credit from this application.',
  },
