...
export const PART_FIELDS = defineResourceFields({
  ...
  // ─── MRP planning overrides (plans/mrp/02-data-structures.md §4) ───
  // Null means "use the planner's proposal or default". Hidden from the panel: the
  // part's Planning tab renders them.
  mrpBufferMode: {
    id: toFieldId('mrpBufferMode'),
    key: 'mrpBufferMode',
    label: 'MRP Buffer Mode',
    type: BaseType.ENUM,
    fieldType: FieldType.SINGLE_SELECT,
    isSystem: true,
    systemAttribute: 'part_mrp_buffer_mode',
    systemSortOrder: 'a6e',
    nullable: true,
    showInPanel: false,
    showInTable: false,
    options: { options: PartMrpBufferMode.values },
    capabilities: {
      filterable: true,
      sortable: true,
      creatable: true,
    ...
    placeholder: 'Select buffer mode',
    defaultValue: PartMrpBufferMode.AUTO,
    description: 'Whether MRP keeps a buffer of this part. Auto follows the planner proposal',
  },

  buildLeadTimeDays: {
    id: toFieldId('buildLeadTimeDays'),
    key: 'buildLeadTimeDays',
    label: 'Build Lead Time (days)',
    type: BaseType.NUMBER,
    fieldType: FieldType.NUMBER,
    isSystem: true,
    systemAttribute: 'part_build_lead_time_days',
    systemSortOrder: 'a6f',
    nullable: true,
    showInPanel: false,
    showInTable: false,
    ...
    description: 'Days to build this part once its components are on hand. Made parts only',
  },

  buildCycleDays: {
    id: toFieldId('buildCycleDays'),
    key: 'buildCycleDays',
    label: 'Build Cycle (days)',
    type: BaseType.NUMBER,
    fieldType: FieldType.NUMBER,
    isSystem: true,
    systemAttribute: 'part_build_cycle_days',
    systemSortOrder: 'a6g',
    nullable: true,
    showInPanel: false,
    showInTable: false,
    ...
    placeholder: 'Enter days',
    description: 'Build this part in batches every N days. Made parts only',
  },

  mrpLeadTimeFactor: {
    id: toFieldId('mrpLeadTimeFactor'),
    key: 'mrpLeadTimeFactor',
    label: 'MRP Lead Time Factor',
    type: BaseType.NUMBER,
    fieldType: FieldType.NUMBER,
    isSystem: true,
    systemAttribute: 'part_mrp_lead_time_factor',
    systemSortOrder: 'a6h',
    nullable: true,
    showInPanel: false,
    showInTable: false,
    ...
    description:
      'Overrides the lead-time factor MRP sizes the red zone with. Empty uses the default',
  },

  mrpVariabilityFactor: {
    id: toFieldId('mrpVariabilityFactor'),
    key: 'mrpVariabilityFactor',
    label: 'MRP Variability Factor',
    type: BaseType.NUMBER,
    fieldType: FieldType.NUMBER,
    isSystem: true,
    systemAttribute: 'part_mrp_variability_factor',
    systemSortOrder: 'a6i',
    nullable: true,
    showInPanel: false,
    showInTable: false,
