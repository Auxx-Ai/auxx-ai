...
export const PAYMENT_GATEWAY_FIELDS: Record<string, ResourceField> = {
  ...
  settlementAccount: {
    id: toFieldId('settlementAccount'),
    key: 'settlementAccount',
    label: 'Settlement account',
    type: BaseType.STRING,
    fieldType: FieldType.TEXT,
    isSystem: true,
    systemAttribute: 'payment_gateway_settlement_account',
    systemSortOrder: 'a5b',
    nullable: true,
    capabilities: {
      filterable: true,
    ...
    description: 'The connected processor account supplying settlement activity.',
  },

  settlementCurrency: {
    id: toFieldId('settlementCurrency'),
    key: 'settlementCurrency',
    label: 'Settlement currency',
    type: BaseType.STRING,
    fieldType: FieldType.TEXT,
    isSystem: true,
    systemAttribute: 'payment_gateway_settlement_currency',
    systemSortOrder: 'a5c',
    nullable: true,
    capabilities: {
      filterable: true,
    ...
    description: 'The currency received from this processor.',
  },

  settlementBankAccount: {
    id: toFieldId('settlementBankAccount'),
    key: 'settlementBankAccount',
    label: 'Receiving bank account',
    type: BaseType.RELATION,
    fieldType: FieldType.RELATIONSHIP,
    isSystem: true,
    systemAttribute: 'payment_gateway_settlement_bank_account',
    systemSortOrder: 'a5d',
    nullable: true,
    capabilities: {
      filterable: true,
    ...
    relationship: {
      inverseResourceFieldId: 'bank_account:settlementGateways' as ResourceFieldId,
    ...
    relationshipConfig: {
      ...
      relationshipType: 'belongs_to',
      inverseName: 'Settlement gateways',
      inverseSystemAttribute: 'bank_account_settlement_gateways',
    },
    description: 'The bank account that receives settlements.',
  },
