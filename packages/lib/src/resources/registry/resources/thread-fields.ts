...
export const THREAD_FIELDS: Record<string, ResourceField> = {
  ...
  sender: {
    ...
    operatorOverrides: ['is', 'is not', 'contains', 'not contains', 'empty', 'not empty'],
  ...
  to: {
    ...
    operatorOverrides: ['is', 'is not', 'contains', 'not contains', 'empty', 'not empty'],
    description: 'Recipient email address (TO, CC, or BCC)',
  ...
  body: {
    ...
    operatorOverrides: ['contains', 'not contains'],
    description: 'Message body content',
    placeholder: 'Search message content',
  },

  freeText: {
    id: toFieldId('freeText'),
    key: 'freeText',
    label: 'Free Text Search',
    type: BaseType.STRING,
    fieldType: FieldType.TEXT,
    isSystem: true,
    systemAttribute: 'free_text',
    dbColumn: undefined,
    nullable: true,
    capabilities: {
      filterable: true,
    ...
    operatorOverrides: ['contains'],
    description: 'Search across subject and body',
  ...
  hasAttachments: {
    ...
    isSystem: true,
    systemAttribute: 'has_attachments',
    dbColumn: undefined,
    nullable: false,
    capabilities: {
      filterable: true,
    ...
    description: 'Whether the thread has messages with attachments',
  },

  hasDraft: {
    id: toFieldId('hasDraft'),
    key: 'hasDraft',
    label: 'Has Draft',
    type: BaseType.BOOLEAN,
    fieldType: FieldType.CHECKBOX,
    isSystem: true,
    systemAttribute: 'has_draft',
    dbColumn: undefined,
    nullable: false,
    capabilities: {
      filterable: true,
    ...
    description: 'Whether the thread has a draft reply',
  },

  sent: {
    id: toFieldId('sent'),
    key: 'sent',
    label: 'Has Outbound Message',
    type: BaseType.BOOLEAN,
    fieldType: FieldType.CHECKBOX,
    isSystem: true,
    systemAttribute: 'sent',
    dbColumn: undefined,
    nullable: false,
    capabilities: {
      filterable: true,
    ...
    description: 'Whether the thread has outbound (sent) messages',
  },
}
