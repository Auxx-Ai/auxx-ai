...
> = {
  ...
  // v3 → v4: + the six `SystemEntityBehavior` fields (`system-entity-behavior.ts`),
  // resolved onto every resource at construction time. An edit to that map's
  ...
  // recomputed per read.
  resources: { prefix: 'org:resources:v6', ttlSeconds: ONE_DAY },
