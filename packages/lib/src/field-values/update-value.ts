// packages/lib/src/field-values/update-value.ts

import { database, schema } from '@auxx/database'
import { fromDatabase } from '@auxx/services/shared/utils'
import { and, eq } from 'drizzle-orm'
import { err, ok } from 'neverthrow'
import type { ServiceFieldValueRow, UpdateFieldValueInput } from './service-types'
...
export async function updateFieldValue(input: UpdateFieldValueInput) {
  ...
  return ok(row as ServiceFieldValueRow)
}
