// packages/lib/src/inboxes/__tests__/personal-inbox-def-consumers.test.ts
...
const { getAutomationVisibility } = await import(
  '../../permissions/visibility/automation-visibility'
)
