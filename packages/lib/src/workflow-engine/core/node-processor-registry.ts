...
import { AppPollingTriggerProcessor } from '../nodes/trigger-nodes/app-polling-trigger-processor'
  ...
  async initializeWithDefaults(): Promise<void> {
    ...
    try {
      ...
      const defaultProcessors = [
        ...
        new AppPollingTriggerProcessor(), // Extension app trigger (polling-driven)
        new IfElseProcessor(),
        new AnswerProcessor(),
