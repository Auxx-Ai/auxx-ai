// packages/lib/src/workflows/graph-edit/layout-constants.ts

// Ported verbatim from apps/web/src/components/workflow/utils/layout-constants.ts
// (Phase 3 §4) so one set of constants positions both agent-added and
// canvas-added nodes. Pure data — browser-safe, no server imports.
