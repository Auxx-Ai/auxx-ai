// packages/lib/src/postings/mint-rail-accounts.ts
...
import { CLEARING_ACCOUNT_CODE_BAND, MERCHANT_FEE_ACCOUNT_CODE_BAND } from './default-chart'
...
export interface MintRailAccountsInput {
   ...
   *
   * Suggested by `suggestRail` (`@auxx/lib/payment-gateways/rail-catalogue`)
