// packages/lib/src/postings/provider-sync/guard.ts
 ...
 * what lets this module bind its own scope, so a refused sync is greppable as
 * `scope='postings:provider-sync'` rather than hiding inside the poster's log
 * stream.
 */
