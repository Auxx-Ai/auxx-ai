// packages/lib/src/postings/export-gate/guard.ts
 ...
 * what lets this module bind its own scope, so a gate refusal is greppable as
 * `scope='postings:export-gate'` rather than hiding inside the poster's stream.
 */
