// packages/lib/src/accounting/providers/quickbooks/__tests__/upsert-customer.test.ts
//
...
describe('readQuickbooksCustomerFields resolves by systemAttribute (§the near-miss)', () => {
  it('names the attributes the contact registry actually declares', async () => {
    ...
    const { CONTACT_FIELDS } = await import(
      '../../../../resources/registry/resources/contact-fields'
    )
