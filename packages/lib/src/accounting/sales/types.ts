// packages/lib/src/accounting/sales/types.ts
...
export interface RecomputeTotalsInput extends MoneyMutationInput {
  documentType?: 'quote' | 'invoice' | 'order' | 'purchase_order' | 'credit_memo' | 'vendor_credit'
  /** EntityInstance id of the totalled document (not the RecordId). */
