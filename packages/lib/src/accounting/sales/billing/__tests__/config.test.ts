// packages/lib/src/accounting/sales/billing/__tests__/config.test.ts

import { describe, expect, it } from 'vitest'
import { assertBillingConfigurationCompatible, isBillingConfigurationCompatible } from '../config'
