// packages/lib/src/accounting/sales/billing/reconciler.ts
...
async function projectWorkOrder(
  ...
  const { syncWorkOrderBillingProjection } = await import('./projection')
...
async function projectInvoice(
  ...
  const { syncInvoiceBillingProjection } = await import('./projection')
...
async function projectContact(
  ...
  const { syncContactBillingProjection } = await import('./projection')
