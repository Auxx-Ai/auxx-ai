// packages/lib/src/accounting/sales/send-email.ts
...
import { markPurchaseOrderSent } from '../purchasing/lifecycle'
import { markInvoiceSent } from './invoices/invoice-lifecycle'
import { buildPayUrl, ensureInvoicePublicToken, isPaymentsConnected } from './public-token'
import { markQuoteSent } from './quotes/quote-lifecycle'
import { buildQuoteViewUrl, ensureQuotePublicToken } from './quotes/quote-public-token'
