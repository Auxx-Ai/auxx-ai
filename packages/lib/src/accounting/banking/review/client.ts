// packages/lib/src/accounting/banking/review/client.ts
 ...
 *
 * ⚠️ Browser code imports `@auxx/lib/accounting/banking/review/client`, never
 * `@auxx/lib/accounting/banking/review`. The barrel reaches Drizzle, the org cache and the
 * poster.
 */
