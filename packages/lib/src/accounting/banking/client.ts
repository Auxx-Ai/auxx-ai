// packages/lib/src/accounting/banking/client.ts
 ...
 *
 * ⚠️ Browser code must import `@auxx/lib/accounting/banking/client`, never
 * `@auxx/lib/accounting/banking`. The barrel reaches Drizzle and the org cache.
 */
