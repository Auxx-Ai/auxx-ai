// packages/lib/src/accounting/banking/rules/client.ts
 ...
 *
 * ⚠️ Browser code must import `@auxx/lib/accounting/banking/rules/client`, never
 * `@auxx/lib/accounting/banking/rules`. The barrel reaches Drizzle and the org cache.
 */
