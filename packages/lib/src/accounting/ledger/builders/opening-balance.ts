// packages/lib/src/accounting/ledger/builders/opening-balance.ts
...
import { parsePeriodKey } from '../periods/periods'
import { isValidTimeZone } from '../setup/setup-readiness'
import type { BuiltEntry } from '../types'
import { buildManualEntry, type ManualEntryLine } from './manual'
