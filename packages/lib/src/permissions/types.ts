...
export enum FeatureKey {
  ...
  aiTranscriptionsPerMonthHard = 'aiTranscriptionsPerMonthHard',
  aiTranscriptionsPerMonthSoft = 'aiTranscriptionsPerMonthSoft',
...
export const FEATURE_REGISTRY: FeatureMetadata[] = [
  ...
  {
    key: FeatureKey.aiTranscriptionsPerMonthHard,
    type: 'usage',
    label: 'AI Transcriptions',
    group: 'AI',
    metric: 'aiTranscriptions',
    variant: 'hard',
    pairedKey: FeatureKey.aiTranscriptionsPerMonthSoft,
    unit: 'requests/mo',
  },
  {
    key: FeatureKey.aiTranscriptionsPerMonthSoft,
    type: 'usage',
    label: 'AI Transcriptions',
    group: 'AI',
    metric: 'aiTranscriptions',
    variant: 'soft',
    pairedKey: FeatureKey.aiTranscriptionsPerMonthHard,
    unit: 'requests/mo',
  },
