// packages/lib/src/data-migrations/migrations/__tests__/152-credit-memo-gl-posting.test.ts
//
...
const { migration152CreditMemoGlPosting, planStamps } = await import(
  '../152-credit-memo-gl-posting'
)
