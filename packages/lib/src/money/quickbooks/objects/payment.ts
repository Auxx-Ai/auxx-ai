// packages/lib/src/money/quickbooks/objects/payment.ts
...
import { exportObjectTypeLabel } from '../../../postings/export/client'
import { exportPaymentSchema, PAYMENT_OBJECT_TYPE } from '../../../postings/export/payloads/payment'
import type {
