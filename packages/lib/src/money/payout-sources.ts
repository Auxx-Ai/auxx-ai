// packages/lib/src/money/payout-sources.ts

import { createScopedLogger } from '@auxx/logger'
import { registerPayoutSource } from './payouts/source-registry'
import { SHOPIFY_PAYMENTS_PAYOUT_SOURCE } from './payouts/sources/shopify-payments'
import { STRIPE_CONNECT_PAYOUT_SOURCE } from './payouts/sources/stripe-connect'
