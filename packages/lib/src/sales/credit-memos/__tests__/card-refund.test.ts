// packages/lib/src/sales/credit-memos/__tests__/card-refund.test.ts
//
...
vi.mock('../../../accounting/money/customer-money/refund-accounting', () => ({
...
vi.mock('../../../accounting/money/stripe-connect/account', () => ({
  getPaymentAccount: async () => ({ stripeAccountId: 'acct_1' }),
}))
vi.mock('../../../accounting/money/stripe-connect/client', () => ({
