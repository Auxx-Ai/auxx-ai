// packages/lib/src/sales/quotes/quote-deposit.ts
...
import { listWorkOrderDepositReceipts } from '../../accounting/money/checkout/reads'
import { applyMoneyToInvoice } from '../../accounting/money/invoice-payments/apply-money'
