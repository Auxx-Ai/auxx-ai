// packages/lib/src/purchasing/bill-edit.ts
//
...
import { VENDOR_BILL_POSTING_TYPE } from '../accounting/ledger/builders/entry'
...
import type { BuiltEntry, GlPostingLineInput } from '../accounting/ledger/types'
