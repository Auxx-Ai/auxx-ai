// packages/lib/src/inventory/builds/client.ts

/**
 * Client-safe half of the builds module: the build-status vocabulary and the
 * pure arithmetic both the browser preview and the server run.
 *
 ...
 * `@auxx/lib/inventory/builds/client` is the one door client code goes through.
 *
 * 🛑 Client code must NEVER import from `@auxx/lib/inventory/builds` — that barrel pulls in
 ...
 * renders exactly this shape, and client code may not reach `@auxx/lib/inventory/builds`
