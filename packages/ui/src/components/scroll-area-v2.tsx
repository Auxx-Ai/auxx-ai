// packages/ui/src/components/scroll-area-v2.tsx
'use client'
...
function ScrollArea({
  ...
  return (
    <BaseScrollArea.Root className={cn('relative box-border', className)}>
      <BaseScrollArea.Viewport
        ...
        <BaseScrollArea.Content style={!showHorizontal ? { minWidth: undefined } : undefined}>
          {children}
