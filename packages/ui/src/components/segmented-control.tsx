...
const segmentedControlVariants = cva('flex', {
  variants: {
...
/**
 * SegmentedControl component for grouping related buttons with optional toggle behavior.
 *
 * @example
 * // Basic usage
 * <SegmentedControl>
...
export function SegmentedControl({
  ...
  return (
    <div
      ...
      className={cn(segmentedControlVariants({ orientation, size }), className)}
      {...props}>
