...
const MultipleSelector = ({
  ...
  // console.log('MultipleSelector render', options)
  ...
  return (
    <Command
      ...
      className={cn(
        'h-auto overflow-visible bg-white dark:bg-transparent',
      ...
      <div
        ...
        <div className='flex flex-wrap gap-1'>
          ...
          <CommandPrimitive.Input
            ...
            className={cn(
              'outline-hidden flex-1  placeholder:text-muted-foreground/70 focus-visible:outline-hidden disabled:cursor-not-allowed',
              {
