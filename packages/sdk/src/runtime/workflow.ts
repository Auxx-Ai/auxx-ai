...
// Handler for getting workflow blocks and triggers (dev-only fallback —
// production reads come from the deployment catalog projected onto the org
// cache envelope; see app-surface-implementation-plan.md §10.1).
