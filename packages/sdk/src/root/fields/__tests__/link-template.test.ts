// packages/sdk/src/root/fields/__tests__/link-template.test.ts

import { describe, expect, it } from 'vitest'
import { type LinkVariable, parseLinkTemplate } from '../link-template.js'

/** Duplicated verbatim in `packages/lib/src/identity/__tests__/link-template.test.ts`
