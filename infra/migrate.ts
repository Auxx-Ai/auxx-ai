...
import { shouldDeployMigrationResources } from './deploy-profile'
import { vpc } from './router-vpc'

export const databaseDeployFunction = shouldDeployMigrationResources()
  ? new sst.aws.Function('DatabaseDeployFunction', {
      vpc,
...
// Run Drizzle migrations automatically after deploy (skipped in sst dev and platform mode).
if (!$dev && databaseDeployFunction) {
